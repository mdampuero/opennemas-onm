...
ALTER TABLE `newsletters` CHANGE `html` `generated_html` MEDIUMTEXT DEFAULT NULL;
...
ALTER TABLE `newsletters` CHANGE `sent` `sends` INT DEFAULT 0 NOT NULL;
ALTER TABLE `newsletters` ADD `send_date` DATETIME DEFAULT CURRENT_TIMESTAMP AFTER `sends`;
