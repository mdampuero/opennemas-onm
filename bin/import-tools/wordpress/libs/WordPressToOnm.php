            ...
            while (!$rs->EOF) {
                ...
                if ($ih->elementIsImported($rs->fields['ID'], 'article') ) {
                    ...
                    $values = array(
                            ...
                            'metadata' => StringUtils::getTags(ImportHelper::convertoUTF8($rs->fields['post_title'])),
                            'subtitle' => '',
                    ...
                    $data = $this->clearLabelsInBodyArticle($rs->fields['post_content']); //extract image html in body
                        $values =
                            array(
                                ...
                                'body' => $data['body'],
                                'metadata' => strip_tags(StringUtils::getTags(ImportHelper::convertoUTF8($rs->fields['post_title']))),
                                'description' => strip_tags(substr($data['body'],0,150)),
                ...
                if ($ih->elementIsImported($rs->fields['ID'], 'image') ) {
                  ...
                  //  $local_file = str_replace(self::$originMedia['originUrl'],'',$rs->fields['guid']);
                    ...
                    $values = array(
                            ...
                            'frontpage' => 0,
                            'in_home' => 0,
                            'metadata' => StringUtils::getTags(ImportHelper::convertoUTF8($rs->fields['post_title'].$rs->fields['post_excerpt'])),
