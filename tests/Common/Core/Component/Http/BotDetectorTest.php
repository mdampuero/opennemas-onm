...
class BotDetectorTest extends KernelTestCase
{
    ...
    public function testIsBot()
    {
        ...
        $headerBag->expects($this->at(0))->method('get')->with('User-Agent')
            ->willReturn('Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36');
        $headerBag->expects($this->at(1))->method('get')->with('User-Agent')
            ->willReturn('Mozilla/5.0 (iPhone; CPU iPhone OS 8_1 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) Version/8.0 Mobile/12B411 Safari/600.1.4 (compatible; YandexBot/3.0; +http://yandex.com/bots)');
