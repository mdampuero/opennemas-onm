...
use Common\ORM\Database\Repository\InstanceUserRepository;

class InstanceUserRepositoryTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->repository =
            new InstanceUserRepository('foo', $this->conn, $this->metadata, $this->cache);
    }
