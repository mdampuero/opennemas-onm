...
use Framework\EventListener\L10nRouterListener;
...
class RouterListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPort($defaultHttpPort, $defaultHttpsPort, $uri, $expectedHttpPort, $expectedHttpsPort)
    {
        ...
        $listener = new L10nRouterListener($urlMatcher, $this->requestStack);
    ...
    {
        new L10nRouterListener(new \stdClass(), $this->requestStack);
    }
    ...
    public function testRequestMatcher()
    {
        ...
        $listener = new L10nRouterListener($requestMatcher, $this->requestStack, new RequestContext());
        $listener->onKernelRequest($event);
    }
    ...
    public function testLoggingParameter($parameter, $log)
    {
        ...
        $listener = new L10nRouterListener($requestMatcher, $this->requestStack, new RequestContext(), $logger);
