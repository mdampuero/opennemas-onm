...
//$last_gallerys = $cm->find_by_category('Album', $actual_category_id,
//' contents.fk_content_type=7 and contents.available=1', 'ORDER BY created DESC LIMIT 0 , 5');
$num_max = 5;
$last_gallerys = $cm->find('Album',
    ' contents.fk_content_type=7 and contents.available=1',
    'ORDER BY created DESC LIMIT 0 , ' . $num_max
);
$gallerys_viewed = $cm->cache->getMostViewedContent(
    'Album',
    true,
    $actual_category_id,
    0,
...
$gallerys_voted = $cm->cache->getMostVotedContent(
    'Album',
    true,
    $actual_category_id,
    0,
...
$most_comments = $cm->cache->getMostComentedContent(
    'Album',
    true,
    $actual_category_id,
    0,
