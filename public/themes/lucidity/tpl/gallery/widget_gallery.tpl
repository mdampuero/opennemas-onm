...
<div class="layout-column first-column span-12">
    <div class="photos-highlighter clearfix span-12">
        <div class="photos-header"><a href="/album/" title="Ir a la secci&oacute;n de galer&iacute;as"><img src="{$params.IMAGE_DIR}widgets/photos-highlighter-header.png" alt=""/></a></div>
        <div class="photos-highlighter-big clearfix">
            <a href="{$lastAlbum[0]->permalink}" title="{$lastAlbum[0]->title|clearslash|escape:'html'}" >
                <img alt="{$lastAlbum[0]->title|clearslash|escape:'html'}" title="{$lastAlbum[0]->title|clearslash|escape:'html'}" src="{$smarty.const.MEDIA_IMG_PATH_WEB}{$lastAlbum[0]->cover}" />
            </a>
        ...
        <ul class="photos-highligher-little-section-links">
            {section name=i start=1 loop=$lastAlbum max=3}
                {if $smarty.section.i.first}
                    <li class="first"><a href="{$lastAlbum[i]->permalink}" title="{$lastAlbum[i]->title|clearslash|escape:'html'}" >
                        <img alt="{$lastAlbum[i]->title|clearslash|escape:'html'}" title="{$lastAlbum[i]->title|clearslash|escape:'html'}" src="{$smarty.const.MEDIA_IMG_PATH_WEB}{$lastAlbum[i]->cover}" />
                    </a></li>
