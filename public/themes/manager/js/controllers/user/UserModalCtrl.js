...
angular.module('ManagerApp.controllers').controller('UserModalCtrl',
    function ($modalInstance, $scope, itemService, messenger, selected) {
        ...
        $scope.delete = function() {
            ...
            itemService.delete('manager_ws_user_delete', selected.id)
        ...
        $scope.deleteSelected = function() {
            ...
            itemService.deleteSelected('manager_ws_users_delete', selected)
                .then(function(response) {
