    ...
    <div class="navbar-inner">
      ...
      <div class="all-actions pull-right">
        <ul class="nav quick-section">
          ...
          <li class="quicklinks">
            <button class="btn btn-success" ng-click="save();" ng-disabled="saving" ng-if="!group.id">
              <i class="fa fa-save" ng-class="{ 'fa-circle-o-notch fa-spin': saving }"></i> {t}Save{/t}
            </button>
            <button class="btn btn-success" ng-click="update();" ng-disabled="saving" ng-if="group.id">
              <i class="fa fa-save" ng-class="{ 'fa-circle-o-notch fa-spin': saving }"></i> {t}Save{/t}
            </button>
          </li>
        </ul>
