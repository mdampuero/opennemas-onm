            ...
            <table class="table no-margin no-padding">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <a ng-href="[% routing.ngGenerate('manager_command_output', { name: 'clean:smarty-cache', data: [theme] }) %]" type="submit" class="btn btn-danger"><i class="fa fa-cog" ng-class="{ 'fa-circle-o-notch fa-spin': saving }"></i> {t}Execute{/t}</a>
                        </td>
                    </tr>
                    </form>
                    <tr ng-repeat="command in commands">
                        ...
                        <td class="right">
                            <div class="btn-group">
                                <a class="btn btn-danger" ng-href="[% routing.ngGenerate('manager_command_output', { name: command.name, data: [] }) %]">
