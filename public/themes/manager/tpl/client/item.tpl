  ...
  <form name="clientForm" novalidate>
    <div class="grid simple">
      <div class="grid-body client-form">
        <div ng-class="{ 'col-lg-8': client.id }">
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-6">
              ...
              <div class="controls">
                <input class="form-control" id="state" name="state" ng-if="client.country !== 'ES'" ng-model="client.state" placeholder="{t}State{/t}" type="text">
        ...
        <div class="col-lg-3 col-lg-offset-1" ng-if="client.id">
          <h4 class="text-center">{t}View on{/t}</h4>
