<div class="modal-body">
  ...
  <h4 class="p-b-30 text-center" ng-if="!template.selected || template.selected == 1">{t}Do you really want to delete the client?{/t}</h4>
  <h4 class="p-b-30 text-center" ng-if="template.selected > 1">{t}Do you really want to delete the selected clients?{/t}</h4>
</div>
<div class="modal-footer row">
  ...
  <div class="col-xs-6">
    <button type="button" class="btn btn-block btn-success" ng-click="confirm()" ng-disabled="loading">
      <h4 class="bold text-uppercase text-white">
