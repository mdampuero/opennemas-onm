<div class="modal-body">
  ...
  <h4 class="p-b-30 text-center" ng-if="!template.selected || template.selected == 1">{t}Do you really want to delete the instance?{/t}</h4>
  <h4 class="p-b-30 text-center" ng-if="template.selected > 1">{t}Do you really want to delete the selected instances?{/t}</h4>
</div>
