...
<div style="float:left; display:block; margin-left:-10px; width:200px;height:200px;">
    ...
    <div class="layout-column last" style="float:left; display:block; margin-left:9px; max-width:200px;">
        <iframe frameborder="0" width="573px" height="200px;" scrolling="no" src="http://www.rtve.es/eltiempo/miCiudad/embedded.html"></iframe>
    </div>
