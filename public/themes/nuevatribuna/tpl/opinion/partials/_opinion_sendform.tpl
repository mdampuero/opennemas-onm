...
<body>
    ...
    <div id="sendform_content">
        ...
        <h4>Envia este artículo de opinión a un amigo</h4>
        <div id="resultado"></div>
        <form id="sendform" method="POST" action="/controllers/opinion_inner.php">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="2" class="tabular-form">
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="body" rows="8" cols="50" size="50">{$opinion->title|clearslash}</textarea>
                    </td>
                </tr>
                <tr>
