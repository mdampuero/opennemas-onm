                        ...
                        <td style="margin:10px 0;">
                            <div style="margin: 0px 0px 0px; padding: 0px; font-family: Arial; font-size:23px; color:#333333; font-weight: normal;  border-top: 1px solid #ccc;">
                                <a href="{$smarty.const.SITE_URL}{generate_uri   content_type="opinion"
                                                                    ...
                                                                    title=$opinion->title
                                                                    category_name=$opinion->author}" target="_blank">
                                    <b>{$opinion->title}</b></div><br><div style="margin: 0px 0px 0px; padding: 0px; color:#666; font-size: 11px; font-weight: bold; text-align: left;">
                                </a>
                                <b>{$agency}</b> | {$date}</div>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div style="font-size:1.2em; color:#222; color:#014687; text-align:right; text-decoration: underline;  font-size: 12px; line-height: 15px;">
                                <a href="{$smarty.const.SITE_URL}{generate_uri   content_type="opinion"
                                                                    ...
                                                                    date=$opinion->created
                                                                    title=$opinion->title
                                                                    category_name=$opinion->author}" target="_blank">Ir al artículo completo</a>
                            </div>
                        </td>
                    </tr>
                </tbody>
