<div class="widget-latest-opinions-clean widget-latest-opinions-clean-wrapper clearfix">
    <div class="widget-header">
        <img src="{$params.IMAGE_DIR}/logos/nuevatribuna-square.png" alt="Opiniones Nueva Tribuna" /> 
        <span>OPINIÓN NUEVA TRIBUNA</span>
    </div>
    <div class="widget-content">
        <ul>
            {section name=a loop=$latestOpinions}
        ...
        <div class="more"><a href="{$smarty.const.SITE_URL}/seccion/opinion"> Ver más opinión »</a></div>
    </div>
</div>