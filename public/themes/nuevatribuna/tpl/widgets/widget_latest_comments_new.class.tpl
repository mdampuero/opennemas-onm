        ...
        <ul>
            ...
            <li {if $smarty.section.a.last}class="last"{/if}>
                ...
                <a style="font-size:0.95em" onmouseout="UnTip()" 
                   onmouseover="Tip('<b>Comentario:</b> {$articles_comments[a]->comment|nl2br|regex_replace:"/[\r\t\n]/":" "|clearslash|regex_replace:"/'/":"\'"|escape:'html'}',BGCOLOR,'#A14646',FONTCOLOR,'#FFFFFF',BORDERCOLOR,'#A14646', SHADOW, false, ABOVE, true, WIDTH, 400)" 
