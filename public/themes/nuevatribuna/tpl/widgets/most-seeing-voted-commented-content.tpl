...
<div class="widget-most-seeing-voted-commented-content widget-most-seeing-voted-commented-content-wrapper clearfix">
   ...
   <div id="widget-most-seeing-voted-commented-content-tab" class="content clearfix">
...
jQuery(document).ready(function(){
   $('#widget-most-seeing-voted-commented-content-tab').tabs();
   $('#widget-most-seeing-voted-commented-content-tab .initially-hidden').css('display','block');
});
</script>