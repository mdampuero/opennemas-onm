...
{block name="content"}
  <div ng-app="BackendApp" ng-controller="UserListCtrl" ng-init="init();backup.master = {if $app.container->get('core.security')->hasPermission('MASTER')}true{else} false{/if};backup.id = {$app.user->id}">
