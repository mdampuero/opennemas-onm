<div class="content" ng-init="init('album', {}, null, null, 'backend_ws_contents_list_home', '{{$smarty.const.CURRENT_LANGUAGE}}', null)">
    ...
    <div class="grid-body">
      ...
      <div class="listing-no-contents ng-cloak" ng-if="!loading && contents.length == 0">
        <div class="center">
          ...
          <h6>{t 1=$total_elements_widget}You must put %1 albums in the HOME{/t}</h6>
        </div>
      </div>
