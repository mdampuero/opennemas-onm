  ...
  <div class="navbar navbar-inverse">
    <div class="navbar-inner">
      ...
      <ul class="nav quick-section pull-right">
        ...
        <li class="quicklinks hidden-xs">
          <button class="btn btn-link" ng-click="updateSelectedItems('backend_ws_contents_batch_toggle_in_home', 'in_home', 1, 'home_loading')" uib-tooltip="{t escape="off"}In home{/t}" uib-tooltip="{t escape="off"}In home{/t}" tooltip-placement="bottom">
            <i class="fa fa-home"></i>
          </button>
        </li>
        <li class="quicklinks hidden-xs">
          <button class="btn btn-link" ng-click="updateSelectedItems('backend_ws_contents_batch_toggle_in_home', 'in_home', 0, 'home_loading')" uib-tooltip="{t escape="off"}Drop from home{/t}" uib-tooltip="{t escape="off"}Drop from home{/t}" tooltip-placement="bottom">
            <i class="fa fa-home"></i>
...
<div class="content" ng-class="{ 'content-grid': mode === 'grid' }" ng-init="setMode('grid');init('album', 'backend_ws_contents_list')">
        ...
        <table class="table table-hover no-margin">
          <thead>
            <tr>
              ...
              {if $category=='widget' || $category=='all'}<th class="hidden-xs" width="200">{t}Section{/t}</th>{/if}
