<div class="grid-collapse-title ng-cloak pointer" ng-click="expanded.slug = !expanded.slug">
  ...
  <a ng-href="{$route}" ng-show="!expanded.slug" class="badge badge-default m-r-10 m-t-2 ng-cloak pull-right text-uppercase text-bold" target="_blank">
...
<div class="grid-collapse-body ng-cloak" ng-class="{ 'expanded': expanded.slug }">
  <div class="form-group">
    ...
    <div class="m-t-10 text-right" ng-if="item.pk_content">
