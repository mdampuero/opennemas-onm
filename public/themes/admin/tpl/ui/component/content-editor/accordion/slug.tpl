<div class="grid-collapse-title ng-cloak pointer" ng-click="expanded.slug = !expanded.slug">
  ...
  <a class="badge badge-default m-r-10 pull-right text-bold text-uppercase" ng-click="$event.stopPropagation()" ng-href="{$iRoute}" ng-show="!expanded.slug && item.pk_content && item.slug" target="_blank">
