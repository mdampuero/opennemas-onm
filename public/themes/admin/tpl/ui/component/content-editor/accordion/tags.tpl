<div class="grid-collapse-title ng-cloak pointer" ng-click="expanded.tags = !expanded.tags">
  ...
  <span class="pull-right" ng-if="!expanded.tags">
    {include file="ui/component/icon/status.tpl" iField="tags" iRequired=true iValidation=true}
  </span>
...
<div class="grid-collapse-body ng-cloak" ng-class="{ 'expanded': expanded.tags }">
  <div class="form-group no-margin">
    ...
    <div class="controls">
      ...
      {include file="ui/component/icon/status.tpl" iClass="form-status-absolute" iField="tags" iRequired=true iValidation=true}
    </div>
  </div>
</div>
