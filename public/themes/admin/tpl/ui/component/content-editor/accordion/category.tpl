...
<div class="grid-collapse-body ng-cloak" ng-class="{ 'expanded': expanded.category }">
  <div class="form-group no-margin">
    <div class="controls">
      <onm-category-selector class="block" default-value-text="{t}Select a category{/t}…" ng-model="{$field}" placeholder="{t}Select a category{/t}…" required selected="selectedCategories"/>
    </div>
  </div>
</div>
