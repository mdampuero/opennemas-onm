                      ...
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <div class="input-group">
                            <input class="form-control" datetime-picker datetime-picker-min="article.created" datetime-picker-max="article.endtime" id="starttime" name="starttime" ng-model="article.starttime" type="datetime">
