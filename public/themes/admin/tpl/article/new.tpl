              ...
              <div class="grid simple">
                <div class="grid-body">
                  ...
                  <div class="form-group" ng-class="{ 'has-error': showRequired && !article.pk_fk_content_category }">
                    ...
                    <div class="controls">
                      <onm-category-selector class="block" default-value-text="{t}Select a category{/t}…" export-model="data.extra.category" hide-archived="true" locale="config.locale.selected" ng-model="article.pk_fk_content_category" placeholder="{t}Select a category{/t}…"></onm-category-selector>
                    </div>
                  </div>
                  <div class="form-group">
