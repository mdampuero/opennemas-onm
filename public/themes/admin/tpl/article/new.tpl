                    ...
                    <div class="contentbox-container">
                        <div class="contentbox">
                            ...
                            <div class="content">
                                ...
                                <input type="checkbox" name="with_comment" id="with_comment"  {if (!isset($article) && ($commentsConfig['with_comments'])) || (isset($article) && $article->with_comment eq 1)}checked{/if} value=1/>
