              ...
              <div class="col-md-4">
                ...
                <div class="thumbnail-wrapper">
                  ...
                  <div class="form-group ng-cloak" ng-show="article.img1">
                    ...
                    <div class="controls">
                      <textarea class="form-control" name="img1_footer" ng-model="article.img1_footer" tooltip-enable="config.locale != data.extra.options.default" tooltip-trigger="focus" uib-tooltip="[% data.article.img1_footer[data.extra.options.default] %]"></textarea>
              ...
              <div class="col-md-4">
                ...
                <div class="thumbnail-wrapper">
                  ...
                  <div class="form-group ng-cloak" ng-show="article.img2">
                    ...
                    <div class="controls">
                      <textarea class="form-control" name="img2_footer" ng-model="article.img2_footer" tooltip-enable="config.locale != data.extra.options.default" tooltip-trigger="focus" uib-tooltip="[% data.article.img1_footer[data.extra.options.default] %]"></textarea>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="thumbnail-wrapper">
                      ...
                      <div class="form-group">
                        <div class="thumbnail-placeholder">
                          ...
                          <div class="dynamic-image-placeholder ng-cloak" ng-if="article.fk_video && article.fk_video.thumb_image">
                            <dynamic-image autoscale="true" class="img-thumbnail" ng-model="article.fk_video.thumb_image" instance="{$smarty.const.INSTANCE_MEDIA}">
                          ...
                          <div class="dynamic-image-placeholder ng-cloak" ng-if="article.fk_video && !article.fk_video.thumb_image">
                            <dynamic-image autoscale="true" class="img-thumbnail" property="thumb" ng-model="article.fk_video">
                              <div class="thumbnail-actions">
                                <div class="thumbnail-action remove-action" ng-click="toggleOverlay('video1')">
                                  <i class="fa fa-trash-o fa-2x"></i>
                                </div>
                      ...
                      <div class="form-group ng-cloak" ng-if="article.fk_video">
                        ...
                        <textarea  class="form-control" name="footer_video" ng-model="article.footer_video" tooltip-enable="config.locale != data.extra.options.default" tooltip-trigger="focus" uib-tooltip="[% data.article.footer_video[data.extra.options.default] %]"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    ...
                    <div class="thumbnail-wrapper">
                      ...
                      <div class="form-group">
                        <div class="thumbnail-placeholder">
                          ...
                          <div class="dynamic-image-placeholder ng-cloak" ng-if="article.fk_video2 && article.fk_video2.thumb_image">
                            <dynamic-image autoscale="true" class="img-thumbnail" ng-model="article.fk_video2.thumb_image" instance="{$smarty.const.INSTANCE_MEDIA}">
                              <div class="thumbnail-actions">
                          ...
                          <div class="dynamic-image-placeholder ng-cloak" ng-if="article.fk_video2 && !article.fk_video2.thumb_image">
                            <dynamic-image autoscale="true" class="img-thumbnail" property="thumb" ng-model="article.fk_video2">
                              <div class="thumbnail-actions">
                                <div class="thumbnail-action remove-action" ng-click="toggleOverlay('video2')">
                                  <i class="fa fa-trash-o fa-2x"></i>
                                </div>
                      ...
                      <div class="form-group ng-cloak" ng-if="article.fk_video2">
                        ...
                        <textarea  class="form-control" name="footer_video2" ng-model="article.footer_video2" tooltip-enable="config.locale != data.extra.options.default" tooltip-trigger="focus" uib-tooltip="[% data.article.footer_video[data.extra.options.default] %]"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
