            ...
            <div class="grid-body">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="titleHome" name="params[titleHome]" type="text" value="{$article->params['titleHome']|clearslash|escape:"html"}"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <textarea id="sumary_home" name="params[summaryHome]">
                                {$article->params['summaryHome']|clearslash}
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            ...
                            {else}
                                {assign var=defaultValue value=26}
                            {/if}
                            <select id="homesize" name="params[titleHomeSize]">
                                {html_options values=$availableSizes options=$availableSizes selected=$defaultValue}
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <select id="img_pos" name="params[imageHomePosition]">
