              ...
              <tr ng-if="items.length >= 0" ng-repeat="content in items" ng-class="{ row_selected: isSelected(content.id) }">
                ...
                <td>
                  ...
                  <div class="listing-inline-actions">
                    {acl isAllowed="ARTICLE_UPDATE"}
                      <translator item="data.results[$index]" keys="data.extra.keys" link="[% routing.generate('admin_article_show', { id: content.id }) %]" ng-if="config.multilanguage" options="data.extra.options" text="{t}Edit{/t}"></translator>
