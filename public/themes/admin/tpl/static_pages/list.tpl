...
{block name="content"}
  <div ng-controller="StaticPageListCtrl" ng-init="init()">
          ...
          <div class="all-actions pull-right">
            <ul class="nav quick-section">
              {acl isAllowed="STATIC_PAGE_CREATE"}
                <li class="quicklinks">
                  <a class="btn btn-loading btn-success text-uppercase" href="{url name=backend_static_page_create}" title="{t}Create new page{/t}">
