    ...
    <div class="content">
        ...
        <div class="grid simple">
            <div class="grid-body">
                ...
                <div class="form-group">
                    <div class="checkbox">
                        <label class="form-label" for="config[with_comments]">{t}Allow comments in contents by default{/t}</label>
                        <span class="help">
                        ...
                        <input id="name" name="configs[with_comments]" type="checkbox" value="1" {if !isset($configs['with_comments']) || $configs['with_comments'] == true}checked="checked"{/if} >
                    </div>
                </div>
                    <div class="form-group">
                        <div class="checkbox">
                            <label class="form-label" for="config[autoaccept]">
                                {t}Before a comment appears{/t}
                            </label>
                            <span class="help">
                                {t}An administrator must always approve the comment {/t}
                            </span>
                            <input id="name" name="configs[moderation]" type="checkbox" value="1" {if $configs['moderation'] == true}checked="checked"{/if} >
                        </div>
                    </div>
                </fieldset>
            </div>
