<form name="clientForm">
  ...
  <div class="row" ng-if="isVatRequired()">
    <div class="form-group col-sm-6" ng-class="{ 'has-error': clientForm.vat_number.$invalid || (clientForm.vat_number.$dirty && !validVat), 'has-success': clientForm.vat_number.$dirty && clientForm.vat_number.$valid && validVat }">
      <div class="input-with-icon right">
        ...
        <i class="fa fa-times text-danger" ng-if="clientForm.vat_number.$invalid && clientForm.vat_number.$error.vat_number || (clientForm.vat_number.$dirty && !validVat)" uib-tooltip="{t}This is not a valid vat_number identification number{/t}"></i>
