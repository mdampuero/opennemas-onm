        ...
        <div class="all-actions pull-right">
          <ul class="nav quick-section">
            ...
            <li class="quicklinks">
              ...
              <button class="btn btn-primary" data-text="{t}Updating{/t}..." href="{url name=admin_books_update id=$book->id}" name="continue" value="1" id="update_button">
              ...
              <button class="btn btn-primary" data-text="{t}Saving{/t}..." href="{url name=admin_books_create}" name="continue" value="1" id="save_button">
                <i class="fa fa-save"></i>
