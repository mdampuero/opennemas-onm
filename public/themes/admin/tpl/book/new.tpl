          ...
          <div class="grid simple">
            <div class="grid-body">
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <onm-category-selector class="block" default-value-text="{t}Select a category{/t}…" hide-archived="true" locale="config.locale.selected" ng-model="book.pk_fk_content_category" placeholder="{t}Select a category{/t}…" required></onm-category-selector>
                </div>
              </div>
              <div class="form-group">
