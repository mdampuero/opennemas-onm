...
{block name="content"}
  <div ng-app="BackendApp" ng-controller="UserGroupListCtrl" ng-init="init()">
    ...
    <div class="content">
      ...
      <div class="listing-no-contents ng-cloak" ng-if="!flags.http.loading && items.length == 0">
        <div class="text-center p-b-15 p-t-15">
          ...
          <h3>{t}Unable to find any user group that matches your search.{/t}</h3>
                ...
                <tr ng-repeat="item in items" ng-class="{ row_selected: isSelected(item.pk_user_group) }">
                  ...
                  <td>
                    ...
                    <div class="listing-inline-actions">
                      <a class="link" href="[% routing.generate('backend_user_group_show', { id: item.pk_user_group }) %]">
    ...
    <script type="text/ng-template" id="modal-delete">
      {include file="user-group/modal.delete.tpl"}
    </script>
  </div>
{/block}
