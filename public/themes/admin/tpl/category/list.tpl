                  ...
                  <td class="v-align-middle">
                    <div class="[% 'm-l-' + 30 * levels[getItemId(item)] %]">
                      ...
                      <div class="listing-inline-actions">
                        <translator item="data.items[$index]" keys="data.extra.keys" link="[% routing.generate('backend_category_show', { id: getItemId(item) }) %]" ng-if="data.extra.locale.multilanguage && data.extra.locale.available" options="data.extra.locale" text="{t}Edit{/t}"></translator>
