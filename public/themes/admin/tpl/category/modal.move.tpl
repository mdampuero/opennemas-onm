<div class="modal-body">
  ...
  <onm-category-selector class="block" categories="template.categories" label-text="{t}Category{/t}" ng-model="template.target" placeholder="{t}Select a category{/t}" required></onm-category-selector>
</div>
