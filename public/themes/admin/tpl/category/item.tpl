              ...
              <div class="grid-body no-padding">
                ...
                <div class="grid-collapse-body ng-cloak" ng-class="{ 'expanded': expanded.category }">
                  <div class="form-group no-margin">
                    <onm-category-selector class="block" default-value-text="{t}Select a category{/t}…" exclude="[ item.pk_content_category ]" hide-archived="true" locale="config.locale.selected" ng-model="item.fk_content_category" selected="selectedCategories" placeholder="{t}Select a category{/t}…"></onm-category-selector>
                  </div>
                </div>
