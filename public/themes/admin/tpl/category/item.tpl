            ...
            <div class="grid simple">
              <div class="grid-body no-padding">
                ...
                <div class="grid-collapse-body ng-cloak" ng-class="{ 'expanded': expanded.category }">
                  <div class="form-group no-margin">
                    <onm-category-selector class="block" categories="data.extra.categories" default-value-text="{t}Select a category{/t}..." ng-model="item.fk_content_category" placeholder="{t}Select a category{/t}"></onm-category-selector>
                  </div>
                </div>
