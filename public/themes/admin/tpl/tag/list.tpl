          ...
          <div class="all-actions pull-right">
            <ul class="nav quick-section">
              {acl isAllowed="TAG_CREATE"}
                <li>
                  <a class="btn btn-success text-uppercase" href="[% routing.generate('backend_tag_create') %]">
            ...
            <table class="table table-hover no-margin">
              <thead>
                <tr>
                  ...
                  <th>{t}Name{/t}</th>
                  <th>{t}Nº contents{/t}</th>
                  <th class="text-center" width="150">
                    <i class="fa fa-check" uib-tooltip="{t}Delete{/t}" tooltip-placement="left"></i>
