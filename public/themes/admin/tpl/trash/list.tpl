              ...
              <tr ng-repeat="content in contents" ng-class="{ row_selected: isSelected(content.id) }">
                ...
                <td>
                  ...
                  <div class="listing-inline-actions">
                    <a ng-if="['static_page', 'event', 'opinion', 'video' ].indexOf(content.content_type_name) !== false" ng-href="[% edit(content.id, 'backend_'+content.content_type_name+'_show') %]" class="link">
                      <i class="fa fa-pencil"></i>
                      {t}Edit{/t}
                    </a>
                    <a ng-if="['static_page', 'event', 'opinion', 'video' ].indexOf(content.content_type_name) === false" ng-href="[% edit(content.id, 'admin_'+content.content_type_name+'_show') %]" class="link">
                      <i class="fa fa-pencil"></i>
                      {t}Edit{/t}
                    </a>
