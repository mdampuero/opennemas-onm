<div data-content-id="{$content->id}" data-class="Poll" {getProperty item=$content category=$params['category'] property='bgcolor' style="true"}
    ...
    <div class="description">
        <input type="checkbox" class="action-button" name="selected-{$smarty.foreach.poll_loop.index}">
        <div class="title">
    ...
    <div class="content-action-buttons btn-group">
        ...
        <ul class="dropdown-menu pull-right">
            ...
            <li class="divider"></li>
            <li>
                <a href="{url name=admin_poll_delete id=$content->id category=$category}" title="{t}Delete{/t}" class="send-to-trash">
