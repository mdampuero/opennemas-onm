  ...
  <div class="ng-cloak row" ng-if="!http.flags.loading">
    <div class="col-lg-4">
      <div class="grid simple">
        <div class="grid-title">
          <h4>
            <img class="m-r-5" src="/themes/admin/images/redis.png" width="20">
            Redis
          </h4>
        </div>
        <div class="grid-body">
    ...
    <div class="col-lg-4">
      <div class="grid simple">
        ...
        <div class="grid-title">
          <h4>
            <img class="m-r-5" src="/themes/admin/images/smarty.png" width="20">
            Smarty
          </h4>
        </div>
        <div class="grid-body">
    ...
    <div class="col-lg-4">
      <div class="grid simple">
        <div class="grid-title">
          <h4>
            <img class="m-r-5" src="/themes/admin/images/varnish.png" width="20">
            Varnish
          </h4>
        </div>
        <div class="grid-body">
