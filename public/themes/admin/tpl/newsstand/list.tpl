      ...
      <div class="navbar-inner">
        <ul class="nav quick-section">
          ...
          <li class="quicklinks hidden-xs ng-cloak">
            <onm-category-selector ng-model="criteria.pk_fk_content_category" categories="data.extra.categories" label-string="{t}Category{/t}" required />
          </li>
            ...
            <tbody>
              <tr ng-repeat="item in items" ng-class="{ row_selected: isSelected(item.id) }">
                ...
                <td class="center hidden-xs hidden-sm">
                  <img ng-src="{$KIOSKO_IMG_URL}[% item.path%][% item.thumb_url %]"
