                  ...
                  <td>
                    ...
                    <div class="listing-inline-actions">
                      {acl isAllowed="EVENT_UPDATE"}
                        ...
                        <translator item="data.items[$index]" keys="data.extra.keys" link="[% routing.generate('backend_event_show', { id: getItemId(item) }) %]" ng-if="data.extra.locale.multilanguage && data.extra.locale.available" options="data.extra.locale" text="{t}Edit{/t}"></translator>
                      {/acl}
                      {acl isAllowed="EVENT_DELETE"}
