          ...
          <div class="grid simple">
            <div class="grid-body no-padding">
              ...
              <div class="grid-collapse-body ng-cloak" ng-class="{ 'expanded': expanded.category }">
                <div class="form-group">
                  <div class="controls">
                    <onm-category-selector ng-model="item.categories[0]" categories="data.extra.categories" placeholder="{t}Select a category{/t}" default-value-text="{t}Select a category...{/t}" required />
                  </div>
                </div>
              </div>
