                      ...
                      <div class="panel panel-default">
                        ...
                        <div class="panel-collapse collapse" id="goggle-analytics">
                          <div class="panel-body">
                            ...
                            <p>{t escape=off}You can get your Google Analytics Site ID from <a class="external-link" ng-click="$event.stopPropagation();" href="https://www.google.com/analytics/" target="_blank">GAnalytics site</a> under the General Overview list (should be something like UA-546457-3).{/t}</p>
                            <small class="help">
                        ...
                        <div class="panel-collapse collapse" id="recaptcha">
                          <div class="panel-body">
                            <div class="row">
                              ...
                              <small class="help">
                                <i class="fa fa-info-circle m-r-5 text-info"></i>
                                {t escape=off}Get your reCaptcha key from <a class="external-link" ng-click="$event.stopPropagation();" href="https://www.google.com/recaptcha/admin#whyrecaptcha" target="_blank">this page</a>.{/t} {t}Used when we want to test if the user is an human and not a robot.{/t}
                              </small>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="panel-collapse collapse" id="paypal">
                          <div class="panel-body">
                            <div class="form-group">
                              ...
                              <small class="help">
                                <i class="fa fa-info-circle m-r-5 text-info"></i>
                                {t escape=off}You can get your PayPal account email from <a class="external-link" ng-click="$event.stopPropagation();" href="https://www.paypal.com/us/cgi-bin/webscr?cmd=_registration-run" target="_blank">PayPal site</a>. This must be a business account for receiving payments{/t}
                              </small>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div class="panel-collapse collapse" id="google-search">
                          <div class="panel-body">
                            ...
                            <small class="help">
                              <i class="fa fa-info-circle m-r-5 text-info"></i>
                              {t escape=off}You can get your Google <strong>Search</strong> API Key from <a class="external-link" ng-click="$event.stopPropagation();" href="http://www.google.com/cse/manage/create" target="_blank">Google Search sign up website</a>.{/t}
                            </small>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div class="panel-collapse collapse" id="google-news">
                          <div class="panel-body">
                            ...
                            <small class="help">
                              <i class="fa fa-info-circle m-r-5 text-info"></i>
                              {t escape=off}You can get your Publication name in <a class="external-link" ng-click="$event.stopPropagation();" href="https://www.google.es/search?num=100&hl=es&safe=off&gl=es&tbm=nws&q={$smarty.server.HTTP_HOST}&oq={$smarty.server.HTTP_HOST}" target="_blank">Google News search</a> for your site.{/t}
                            </small>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div class="panel-collapse collapse" id="google-maps">
                          <div class="panel-body">
                            ...
                            <small class="help">
                              <i class="fa fa-info-circle m-r-5 text-info"></i>
                              {t escape=off}You can get your Google <strong>Maps</strong> API Key from <a class="external-link" ng-click="$event.stopPropagation();" href="http://code.google.com/apis/maps/signup.html" target="_blank">Google maps sign up website</a>.{/t}
                            </small>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div class="panel-collapse collapse" id="google-tags">
                          <div class="panel-body">
                            ...
                            <small class="help">
                              <i class="fa fa-info-circle m-r-5 text-info"></i>
                              {t escape=off}You can get your Google <strong>Tags</strong> container Id from <a class="external-link" ng-click="$event.stopPropagation();" href="https://tagmanager.google.com/#/home" target="_blank">Google tags sign up website</a>.{/t}
                            </small>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="panel-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="controls">
                                ...
                                <span class="help">
                                  {t escape=off}You can get your Facebook App Keys from <a class="external-link" ng-click="$event.stopPropagation();"  href="https://developers.facebook.com/apps" target="_blank">Facebook Developers website</a>.{/t}
                                </span>
                              </div>
                            </div>
                            <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <span class="help">
                              {t escape=off}Add custom robots.txt rules like 'Disallow: /tag'. Refer to the <a ng-click="$event.stopPropagation();" href="http://www.robotstxt.org/robotstxt.html" target="_blank">documentation</a>.{/t}
                            </span>
                            <div class="controls">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <div class="checkbox">
                              <input {if $configs['redirection'] eq "1"}checked{/if} id="redirection" name="redirection" ng-model="redirection" ng-true-value="'1'" type="checkbox">
