              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <div class="input-group" id="title" >
                    <input class="form-control" name="title" ng-blur="generate()" ng-model="title" ng-trim="false" required type="text" value="{$opinion->title|clearslash|escape:"html"}"/>
              ...
              <div class="grid simple">
                ...
                <div class="grid-body">
                  ...
                  {is_module_activated name="COMMENT_MANAGER"}
                    <div class="form-group">
                      <div class="checkbox">
                        <input id="with_comment" name="with_comment" type="checkbox" {if (!isset($opinion) && (!isset($enableComments) || $enableComments) eq 1) || (isset($opinion) && $opinion->with_comment eq 1)}checked{/if}  />
                    ...
                    <div class="controls">
                      {acl isAllowed="CONTENT_OTHER_UPDATE"}
                        <select id="fk_author" name="fk_author" required>
                          ...
                          <option value="{$author->id}" {if $opinion->fk_author eq $author->id}selected{/if}>{$author->name} {if $author->is_blog eq 1} (Blog) {/if}</option>
                          {/foreach}
                        </select>
                      {aclelse}
