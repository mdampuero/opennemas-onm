            ...
            <ul class="nav quick-section pull-right">
                ...
                {acl isAllowed="CONTENT_OTHER_DELETE"}
                    {acl isAllowed="OPINION_DELETE"}
                        <li class="quicklinks">
                            <a class="btn btn-link" href="#" ng-click="open('modal-delete-selected', 'backend_ws_contents_batch_send_to_trash')" tooltip="{t}Delete{/t}" tooltip-placement="bottom">
    ...
    <div class="grid simple">
                        ...
                        <tr ng-if="shvs.contents.length > 0" ng-repeat="content in shvs.contents" ng-class="{ row_selected: isSelected(content.id) }">
                            ...
                            <td>
                                ...
                                <div class="listing-inline-actions">
                                    ...
                                    {/acl}
                                    {acl isAllowed="OPINION_DELETE"}
                                        <button class="link link-danger" {acl isNotAllowed="CONTENT_OTHER_DELETE"} ng-if="content.fk_author == {$smarty.session.userid}"{/acl} ng-click="open('modal-delete', 'backend_ws_content_send_to_trash', $index)" type="button">
        ...
        <div class="grid-footer clearfix" ng-if="!loading">
            ...
            <div class="pull-right" ng-if="shvs.contents.length > 0">
                <pagination class="no-margin" max-size="5" direction-links="true"  on-select-page="selectPage(page, 'backend_ws_opinions_list')" ng-model="shvs.page" total-items="shvs.total" num-pages="pages"></pagination>
            </div>
        </div>
    </div>
</div>
