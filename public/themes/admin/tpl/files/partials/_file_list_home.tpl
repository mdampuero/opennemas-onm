<div class="content" ng-init="init('attachment', {}, null, null, 'backend_ws_contents_list_home', '{{$smarty.const.CURRENT_LANGUAGE}}', null)">
...
<script type="text/ng-template" id="item">
  <div class="widget-home-item clearfix" ui-tree-handle>
    ...
    <span class="item-title">
      <a data-nodrag ng-href="[% edit(item.id, 'admin_file_show') %]">
        [% item.title %]
      </a>
      <p class="no-margin">
