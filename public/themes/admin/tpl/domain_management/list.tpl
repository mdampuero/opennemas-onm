  ...
  <div class="row">
    <div class="col-vlg-6 col-vlg-offset-3 col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
      <div class="row p-b-20">
        <div class="col-sm-6">
          <a class="btn btn-block btn-white" href="{url name=admin_domain_management_add}" id="add-redirection-button">
        ...
        <div class="col-sm-6">
          <a class="btn btn-block btn-success" href="{url name=admin_domain_management_add create=1}" id="add-domain-button">
