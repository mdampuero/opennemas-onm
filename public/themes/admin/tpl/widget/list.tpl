      ...
      <div class="navbar-inner">
        ...
        <div class="all-actions pull-right">
          <ul class="nav quick-section">
            ...
            <li class="quicklinks">
              <a href="{url name=admin_widget_create}" class="btn btn-primary" id="create_button">
    ...
    <div class="navbar navbar-inverse">
      <div class="navbar-inner">
        <ul class="nav quick-section pull-left">
          <li class="quicklinks">
            <button class="btn btn-link" ng-click="deselectAll()" uib-tooltip="{t}Clear selection{/t}" tooltip-placement="right" type="button" id="deselect_button">
        ...
        <ul class="nav quick-section pull-right">
          ...
          <li class="quicklinks">
            <button class="btn btn-link" ng-click="sendToTrashSelected()" uib-tooltip="{t}Delete{/t}" tooltip-placement="bottom" type="button" id="send_to_trash_button">
