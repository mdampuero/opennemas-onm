<div class="form-controlgroup">
  ...
  <div class="controls">
    <input type="text" id="title" name="title" ng-blur="autoGenerateTags = true" ng-model="title" value="{$video->title|clearslash|escape:"html"|default:""}" required class="form-control"/>
  </div>
</div>
