<div class="form-group">
  ...
  <div class="controls">
    <input  type="text" id="title" ng-blur="autoGenerateTags = true" ng-model="title" name="title" value="{$video->title|clearslash|escape:"html"|default:$information['title']}" required class="form-control"/>
  </div>
</div>
<div class="form-group">
