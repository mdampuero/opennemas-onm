<div class="content" ng-init="init('video', {}, null, null, 'backend_ws_contents_list_home', '{{$smarty.const.CURRENT_LANGUAGE}}', null)">
    ...
    <div class="grid-body">
      ...
      <div class="listing-no-contents ng-cloak" ng-if="!loading && contents.length == 0">
        <div class="center">
          ...
          <h6>{t 1=$total_elements_widget}You must put %1 videos in the HOME{/t}</h6>
        </div>
      </div>
...
<script type="text/ng-template" id="item">
  <div class="widget-home-item clearfix" ui-tree-handle>
    ...
    <span class="item-title">
      <a data-nodrag ng-href="[% edit(item.id, 'admin_video_show') %]">
        [% item.title %]
      </a>
      <p class="no-margin">
