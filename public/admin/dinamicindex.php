...
for ( $c = 0,$aux = 0; $c <= $ArtPerColumn,$evenpublished[$aux]->title != "" ; $c++, $aux ++ ) {
    ...
    foreach($reles as $attaches) {				 
        ...
        if($resul->category==1){
            ...
            $resul->category==2){$cat1[$c][]="galicia";
        }elseif(
            $resul->category==3){$cat1[$c][]="asturias";
        }elseif(
            $resul->category==4){$cat1[$c][]="cronicas";
        }elseif(
            $resul->category==5){$cat1[$c][]="canarias";
        }elseif(
            $resul->category==6){$cat1[$c][]="castillaleon";
        }elseif(
            $resul->category==7){$cat1[$c][]="madrid";
        }elseif(
            $resul->category==8){$cat1[$c][]="baleares";
        }elseif(
            $resul->category==9){$cat1[$c][]="andalucia";
        }
    }
...
for ( $c = 0 ,$aux = 0; $c <= $ArtPerColumn,$oddpublished[$aux]->title != ""; $c++, $aux ++ ) {
    ...
    foreach($reles as $attaches) {				 
        ...
        if($resul->category==1){
            $cat[]="cronicas";
        }elseif($resul->category==2){
            $cat2[$c][]="galicia";
        }elseif($resul->category==3){
            $cat2[$c][]="asturias";
        }elseif($resul->category==4){
            $cat2[$c][]="cronicas";
        }elseif($resul->category==5){
            $cat2[$c][]="canarias";
        }elseif($resul->category==6){
            $cat2[$c][]="castillaleon";
        }elseif($resul->category==7){
            $cat2[$c][]="madrid";
        }elseif($resul->category==8){
            $cat2[$c][]="baleares";
        }elseif($resul->category==9){
            $cat2[$c][]="andalucia";
        }
    }
