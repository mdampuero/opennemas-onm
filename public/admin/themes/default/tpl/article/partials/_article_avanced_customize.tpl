        ...
        <td>
            <fieldset>
                ...
                <table><tbody>
                    <tr>
                        <td>
                            <label>{t}Size for title in frontpage{/t}</label>
                            <select name="params[titleSize]">
                                {html_options options=$availableSizes selected=$article->params['titleSize']|default:"26"}
                            </select>
                        </td>
                        <td></td>
                        <td >
            ...
            <fieldset>
                ...
                <table style="width:100%;">
                    <tbody>
                        <tr>
                            <td>
                                <label for="titleHome">{t}Title in Home Frontpage{/t}</label>
                            ...
                            <td>
                                <label>{t}Size for title in Home Frontpage{/t}</label>
                        ...
                        <tr>
                            <td colspan="2">
                                <label for="subtitleHome">{t}Subtitle in Home Frontpage{/t}</label>
                        ...
                        <tr>
                            <td  colspan="2">
                                <label for="sumary_home">{t}Summary in Home Frontpage{/t}</label>
                        ...
                        <tr>
                            <td  colspan="2">
                                <label for="img_pos">{t}Image position in Home Frontpage{/t}</label>
