...
<div class="top-action-bar">
	<div class="wrapper-content">
		...
		<ul class="old-button">
			...
			<li>
				<a href="#" class="admin_add" id="validate-button" onClick="sendFormValidate(this, '_self', 'validate', '{$article->id|default:""}', 'formulario');" title="{t}Save and continue{/t}">
			...
			<li>
				<a href="#" class="admin_add" id="save-button" onClick="sendFormValidate(this, '_self', 'create', 0, 'formulario');" >
...
<div class="top-action-bar">
	<div class="wrapper-content">
		...
		<ul class="old-button">
            ...
            {acl isAllowed="ARTICLE_UPDATE"}
		    <li>
                <a href="#" class="admin_add" id="save-button" onClick="sendFormValidate(this, '_self', 'validate', '{$article->id|default:""}', 'formulario');" title="{t}Save and continue{/t}">
            ...
            {acl isAllowed="ARTICLE_UPDATE"}
            <li>
                <a href="#" class="admin_add" id="validate-button" onClick="sendFormValidate(this, '_self', 'update', '{$article->id|default:""}', 'formulario');" id="button_save">
