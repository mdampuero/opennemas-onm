<div class="clearfix">
    <div id="selector" class="tabs">
        <ul>
            <li>
            {if $article eq null}
                <a onclick="search_related(0, $('metadata').value,1);divs_hide('search-noticias');">
                    {t}Suggested articles{/t}
                </a>
            {else}
                <a onclick="search_related({$article->pk_article},$('metadata').value,1);divs_hide('search-noticias');">
                    {t}Suggested articles{/t}
                </a>
            {/if}
            </li>
            <li>
                <a onclick="get_div_contents(0,'noticias','{$article->category|default:36}',1);">
                    {t}Articles by section{/t}
                </a>
            </li>
            <li>
                <a onclick="get_div_contents(0,'hemeroteca','{$article->category}',1);">
                    {t}Articles in library{/t}
                </a>
            </li>
            <li>
                <a onclick="get_div_contents(0,'pendientes','{$article->category}',1);">
                    {t}Articles for review{/t}
                </a>
            </li>
            <li>
                <a onclick="get_div_contents(0,'opinions',0,1);">
                    {t}Opinions{/t}
                </a>
            </li>
            <li>
                <a onclick="get_div_contents(0,'albums',3,1);">
                    {t}Albums{/t}
                </a>
            </li>
            <li>
                <a onclick="get_div_contents(0,'videos',0,1);">
                    {t}Videos{/t}
                </a>
            </li>
            <li>
                <a onclick="get_div_contents(0,'adjuntos', '{$article->category}',1);">
                    {t}Files{/t}
                </a>
            </li>
            <li>
                <a onclick="divs_hide('search-div'); ">
                    {t}Search{/t}
                </a>
            </li>
        </ul>
    ...
    <div id="available-suggested-contents" class="clearfix" >
        ...
        <div id="noticias_div" class='div_lists' style="display:none">
