...
<br style="clear:both;"/>
<div id="cates" style="float:left;width:90%;{if $special->only_pdf eq 0}display:inline;{else}display:none;{/if}">
     ...
     <div class="elements">
        ...
        <div id="articles" style="float:left;width:100%;">
            ...
            <div id="art" style="width:60%;float:left;border:1px solid gray;">
                <br>
                <br>
            </div>
        </div>
