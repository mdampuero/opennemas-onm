...
<tr>	
	  ...
	  <div id="img_portada" style="display:block;">
		  <div id="nifty" style="width:560px;display:block;">
  			<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
					...
					<tr><td>
						<h2 style="color: #2f6d9d;">Imagen de Portada:</h2>
					  ...
					  <td  align='right'>
					 	 <a style="cursor:pointer;"  onclick="javascript:recuperar_eliminar('img1');">
		                     <img src="themes/default/images/remove_image.png" id="remove_img1" alt="Eliminar" title="Eliminar" border="0" align="absmiddle" /> </a>         
					  </td>
					  
					 </tr><tr>
					 <td align='left'> 					 				
						  <div id="droppable_div1">	 																							
								<img src="../media/images/default_img.jpg" id="change1" name="default_img" border="0" width="300px" />													
							</div>
                        <div style="clear: both;"></div>
				  	</td>
                    <td style="text-align:left;white-space:normal;" colspan="2">		
	...
	<td valign="top" align="right"  rowspan="3" >				
				 ...
				 <div  onclick="new Effect.toggle($('videos'),'blind')" style="cursor:pointer;width:438px;height:22px; border:1px double #333333;background-color:#EEE;padding:4px;overflow:none;">
				 	<a style="cursor:pointer;" onclick="new Effect.toggle($('videos-container'),'blind')"> <b>Videos</b> </a>
				 </div>
    
                 <div id="videos-container" class="photos" style="width:440px; height:400px; border:3px double #333333; padding:1px;overflow:hidden;">
                    <br>
                    <table width="98%"><tr><td><div class="cajaBusqueda" style="width:100%;" align="left"><input class="textoABuscar" id="stringVideoSearch" name="stringVideoSearch" type="text"  onkeypress="onVideoKeyEnter(event, $('stringVideoSearch').value,1);" onclick="this.select();" value="Busqueda Videos..." align="left"/></div></td></tr></table>
                    <br>
                    <div id="videos" class="photos" style="width:440px; height:380px; border:0px double #333333; padding:0px;overflow:auto;">
					...
					<h2 style="color:#2f6d9d;">Imagen Interior:</h2></td>
					 ...
					 <td align='left'> 
					   ...
					   <div id="droppable_div2">						 																			
						 <img src="../media/images/default_img.jpg" id="change2" name="default_img" border="0" width="300px" />						
						</div>
					</td>						
