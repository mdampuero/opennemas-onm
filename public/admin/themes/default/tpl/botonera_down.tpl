                        ...
                        {if $category eq 'home'}
                                 <li>
                                    <a href="#" class="admin_add" onClick="javascript:enviar2(this, '_self', 'm_inhome_status', 0);" name="submit_mult" value="no Sugeridas" title="no Sugeridas">
                                            <img border="0" src="{$params.IMAGE_DIR}home_no50.png" title="No home" alt="No home" ><br />No home
                                    </a>
                            </li>
                        {else}
			<li>
				<a href="#" class="admin_add" onClick="javascript:enviar2(this, '_self', 'mfrontpage', 1);" name="submit_mult" value="noFrontpage" title="noFrontpage">
					<img border="0" src="{$params.IMAGE_DIR}publish.gif" title="noFrontpage" alt="noFrontpage" ><br />Publicar
				</a>
			</li>                     
                            <li>
                            ...
                            <li>
                                    <button type="button" style="cursor:pointer; background-color: #e1e3e5; border: 0px; height: 70px;" onClick="javascript:checkAll(this.form['no_selected_fld[]'],'select_button2');">
                                            <img id="select_button2"  status="0" class="icon" src="{$params.IMAGE_DIR}select_button.png" title="Seleccionar Todo" alt="Seleccionar Todo">
                                    </button>
                            </li>
                        {/if}
                            <li>
		...
		<ul>
			...
			<li>
				<button type="button" style="cursor:pointer; background-color: #e1e3e5; border: 0px; height: 70px;" onClick="javascript:checkAll(this.form['selected_fld[]'],'select_button2');">
					<img id="select_button2" class="icon" src="{$params.IMAGE_DIR}select_button.png" title="Seleccionar Todo" alt="Seleccionar Todo"> 
				</button>
			</li>
		</ul>
	</div>
...
{elseif preg_match('/opinion\.php/',$smarty.server.SCRIPT_NAME)}
	...
	<div id="menu-acciones-admin" class="clearfix">
		<ul>
			...
			<li>
				<button type="button" style="cursor:pointer; background-color: #e1e3e5; border: 0px; width:95px;" onClick="javascript:checkAll(this.form['selected_fld[]'],'select_button2');">
					<img id="select_button2" class="icon" src="{$params.IMAGE_DIR}select_button.png" title="Seleccionar Todo" alt="Seleccionar Todo"> 
				</button>
			</li>
			<li>
		...
		<ul>
			...
			<li>
				<a href="#" class="admin_add" onClick="javascript:enviar2(this, '_self', 'mstatus', 1);" name="submit_mult" value="Archivar" title="Archivar">
				    <img border="0" src="{$params.IMAGE_DIR}archive_no.png" title="Archivar" alt="Archivar"><br />Recuperar
				</a>
			</li>
			<li>
				<button type="button" style="cursor:pointer; background-color: #e1e3e5; border: 0px; height: 70px;" onClick="javascript:checkAll(this.form['selected_fld[]'],'select_button2');">
