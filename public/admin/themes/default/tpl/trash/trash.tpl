...
{/section} *}
<li><a href="{$_SERVER['PHP_SELF']}?action=list&mytype=article" {if $mytype=='article'} style="color:#000000; font-weight:bold; background-color:#BFD9BF" {/if}>{t}Articles{/t}</a></li>
