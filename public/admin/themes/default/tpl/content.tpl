...
<tr>
	<td class="barra_superior">&nbsp;<img src="{$params.IMAGE_DIR}admin_contenido.gif" border="0" align="absmiddle" />&nbsp;{$titulo_barra}</td>
</tr>
<tr>
	<td background="{$params.IMAGE_DIR}barra_vrd.gif" height="25" style="border:1px solid #CACACA;" valign="middle">	
		&nbsp;&nbsp;
		<a href="#" onclick="enviar(this, '_self', 'frm_set', 0);" onmouseover="this.T_BGCOLOR='#EAEAEA';this.T_FONTCOLOR='#425542';this.T_WIDTH=150;this.T_BORDERCOLOR='#637F63';return escape('<u>N</u>uevo contenido');" accesskey="N" tabindex="1"><img src="{$params.IMAGE_DIR}iconos/nuevo_contenido.gif" border="0" align="absmiddle" /></a>&nbsp;
		<a href="?{$smarty.now}" onmouseover="this.T_BGCOLOR='#EAEAEA';this.T_FONTCOLOR='#425542';this.T_WIDTH=150;this.T_BORDERCOLOR='#637F63';return escape('<u>L</u>istado de contenidos');" accesskey="L" tabindex="2"><img src="{$params.IMAGE_DIR}iconos/estructura.gif" border="0" align="absmiddle" /></a>&nbsp;
...
<tr>
	...
	<tr>
		...
		<td style="padding:10px;">
			<a href="#" onClick="javascript:enviar(this, '_self', 'frm_upd', {$cont[c].idcontenido});" title="Modificar"><img src="{$params.IMAGE_DIR}btn_modificar.gif" border="0" /></a>
		</td>
		<td style="padding:10px;">
			<a href="#" onClick="javascript:confirmar(this, {$cont[c].idcontenido});" title="Eliminar"><img src="{$params.IMAGE_DIR}btn_eliminar.gif" border="0" /></a>
		</td>
	</tr>
	{sectionelse}
	<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="fuente_cuerpo" width="600">
		...
		<a href="#" onClick="javascript:seleccionar_fichero('imagen','jpg,jpeg,png,gif');">
			<img src="{$params.IMAGE_DIR}icon_examinar.gif" align="absbottom" border="0" />
		</a>
				</td>
	</tr>
	    <tr>
	...
	<tr>
		<td colspan="2" align="right"><a href="#" onClick="javascript:enviar(this, '_self', 'set', 0);"><img src="{$params.IMAGE_DIR}btn_guardar.gif" border="0" /></a>&nbsp;&nbsp;</td>
	</tr>
	</table>
	{/if}
	...
	<tr>
		<td style="padding:4px;"><a href="#" onClick="javascript:enviar(this, '_self', 'save_version', '{$idcontenido}');"><img src="{$params.IMAGE_DIR}btn_guardar_version.gif" border="0" /></a></td>
		<td align="right" style="padding:4px;"><a href="#" onClick="javascript:enviar(this, '_self', 'upd', '{$idcontenido}');"><img src="{$params.IMAGE_DIR}btn_aplicar.gif" border="0" /></a></td>
	</tr>
	</table>
	{/if}
	...
	<tr>
		...
		{if count($versiones)>0}
            ...
            <a href="#" onclick="javascript:enviar(this, '_self', 'get_version', {if isset($idcontenido)}{$idcontenido}{else}0{/if});"><img src="{$params.IMAGE_DIR}btn_ver.gif" border="0" align="absmiddle" /></a>&nbsp;
			<a href="#" onclick="javascript:enviar(this, '_self', 'set_version', {if isset($idcontenido)}{$idcontenido}{else}0{/if});"><img src="{$params.IMAGE_DIR}btn_restaurar.gif" border="0" align="absmiddle" /></a>&nbsp;
			<a href="#" onclick="javascript:enviar(this, '_self', 'del_version', {if isset($idcontenido)}{$idcontenido}{else}0{/if});"><img src="{$params.IMAGE_DIR}btn_eliminar.gif" border="0" align="absmiddle" /></a>
		{else}
	...
	<tr>
		<td colspan="2" align="right"><a href="#" onClick="javascript:enviar(this, '_self', 'set_version', {if isset($idcontenido)}{$idcontenido}{else}0{/if});"><img src="{$params.IMAGE_DIR}btn_restaurar.gif" border="0" /></a>&nbsp;&nbsp;</td>
	</tr>
	</table>
	...
	<tr>
		...
		<td align="center" nowrap="nowrap" valign="top">
			...
			<a href="#" onclick="javascript:relacionar_contenidos();" title="&nbsp;&gt;&nbsp;"><img src="{$params.IMAGE_DIR}btn_siguiente.gif" border="0" align="absmiddle" /></a>
		</td>
		<td align="center" valign="top" nowrap="nowrap">
		  <select name="relacionados" id="relacionados" size="11" class="lista">
		  {html_options options=$relacionados}
		  </select>
		  <a href="#" onclick="javascript:eliminar_relacion();" title="Eliminar Contenido Relacionado"><img src="{$params.IMAGE_DIR}btn_eliminar_aspa.gif" border="0" align="top" /></a>	
		</td>
	</tr>
	<tr>
		<td colspan="3" align="right" style="padding-top:20px;"><a href="#" onClick="javascript:enviar(this, '_self', 'set_relaciones', {if isset($idcontenido)}{$idcontenido}{else}0{/if});"><img src="{$params.IMAGE_DIR}btn_aplicar.gif" border="0" /></a></td>
	</tr>
	</table>
