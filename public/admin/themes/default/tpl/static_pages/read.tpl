    ...
    <div class="wrapper-content">
        <table class="adminform" style="padding:10px;">
            ...
            <tr>
                ...
                <td valign="top" style="padding:4px; text-align:right;" rowspan="2">
            ...
            <tr>
                <td style="padding:4px 0 4px 4px;">
                    <label for="name">{t}Direction:{/t}</label>
                    ...
                    <input type="text" id="slug" name="slug" title="{t}Keywords{/t}" value="{$page->slug|default:""}"
                           class="required" style="width:60%" maxlength="120" tabindex="2" style="display:inline;" />
                    <span>.html</span>
                </td>
            </tr>
            <tr>
                <td>
                    <label for="available">{t}Keywords{/t} <small>{t}(separated with comas){/t}</small> </label>
