...
<tbody>
    <tr> 
        <td bgcolor="#014687">                        
            <a href="http://www.retrincos.info/" target="_blank">
                ...
                {else}
                    <img src="{$URL_PUBLIC}/themes/xornal/images/xornal-boletin.jpg" border="0" alt="Boletín de {$smarty.const.SITE_FULLNAME}" /></a>
                {/if}                
            <br />
        </td>
    </tr>
    ...
    <tr>
        ...
        Recibe el presente bolet&iacute;n tras solicitar este servicio a trav&eacute;s de la web de
        <a href="http://www.xornal.com"><b>RETRINCOS.INFO</b></a>. Puede en todo momento modificar o cancelar su suscripci&oacute;n
    ...
    <tr>
        <td align="center">
            <b>{$smarty.const.SITE_FULLNAME}</b> Informaci&oacute;n con criterio al servicio de Galicia
        </td>
    </tr>
