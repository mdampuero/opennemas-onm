...
<tr>
    <td colspan="3" >
        <p><label>{t}Album images (Double click to select and cut images){/t}</label></p>
	    <div id="scroll-album">
...
<tr>
	...
	<td  align="right" rowspan="2">
        ...
        <div id="photos_container" class="photos"
            ...
            <div id="photos" class="photos" style="height:440px; border:0px double #333333; margin:5px; overflow:auto;">
