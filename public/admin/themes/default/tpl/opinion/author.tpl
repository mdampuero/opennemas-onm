					...
					<table border=0>
						<tr>
							<td valign="top" style="padding:4px;border:1px solid #CCCCCC">
								...
								<br>
								<div id="contenedor" name="contenedor" style="display:none; width:100%;"> </div>
								<div class="photos" style="width:100%; padding:8px; ">
									 <ul id='thelist'  class="gallery_list" style="width:100%;">
						...
						<tr>
							...
							<td style="padding:4px;border:1px solid #CCCCCC">
								<div id="iframe" style="display: inline;">
									<iframe src="newPhoto.php?nameCat=authors&category=7" width="670" height="300" align="center" frameborder="0" framespacing="0" scrolling="none" border="0"></iframe>
								</div>
							</td>
						</tr>
					</table>
