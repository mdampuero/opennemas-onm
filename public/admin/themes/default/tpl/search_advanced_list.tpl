                         ...
                         {else}
                            {if ($arrayResults[c].type == 'artigo')}
                                ...
                                {elseif  ($arrayResults[c].available eq 1) && ($arrayResults[c].content_status eq 0)}
                                    <img src="{$params.IMAGE_DIR}save_hemeroteca_icon.png" border="0" alt="En Hemeroteca" title="En Hemeroteca" />
                                {else}
                                    <img src="{$params.IMAGE_DIR}publish_r.png" border="0" alt="En Pendientes" title="En Pendientes" />
                                {/if}
                     ...
                     <td style="padding:10px;width:10%;" align="center">
                         {if ($arrayResults[c].in_litter == 1)}
                               <a href="/admin/litter.php?action=no_in_litter&desde=search&id={$arrayResults[c].id}&category={$arrayResults[c].category}" title="Recuperar de la Papelera">
                                  <img src="{$params.IMAGE_DIR}trash_no.png" border="0" width="24" alt="Recuperar de Papelera" title="Recuperar de Papelera" />
                               </a>
                         {else}
                            {if ($arrayResults[c].type == 'artigo')}
                    ...
                    <td style="padding:10px;width:10%;" align="center">
                     ...
                     <td style="padding:10px;width:10%;" align="center">
                        <a href="#" accesskey="N'" onmouseover="return escape('<u>N</u>otificar');" onclick="send_notify('{$arrayResults[c].id}','confirm_notify');" >
                            <img border="0" src="{$params.IMAGE_DIR}file_alert.png" title="Notificar" alt="Notificar" /></a>
                    </td>
                </tr>
                {sectionelse}
                <tr>
