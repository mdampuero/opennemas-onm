...
// +----------------------------------------------------------------------+
//
// $Id: index.php, v 0.22 Mon Sep 13 2010 17:46:50 GMT+0200 (CEST) Antonio Jozzolino $
//
...
* @version    $Id: index.php, v 0.22 Mon Sep 13 2010 17:46:50 GMT+0200 (CEST) Antonio Jozzolino $
* @since      Mon Sep 06 2010 01:20:51 GMT+0200 (CEST)
* @access     public
...
if( Privileges_check::CheckPrivileges('USER_ADMIN') ) {
    // Peticiones por Ajax
//    $requested_with = filter_input(INPUT_SERVER, 'HTTP_X_REQUESTED_WITH', FILTER_SANITIZE_STRING );
//    if( isset($requested_with) && $requrested_with == 'XMLHttpRequest') {
