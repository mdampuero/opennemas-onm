...
*/
define ('SITE_TITLE', "retrincos.info - OpenNemas - News Management System - CMS for online newspapers");   // Title to use in the frontend
define ('SITE_DESCRIPTION', "Noticias de Ultima hora sobre la actualidad, nacional, economia, deportes, cultura, sociedad. Adema vieos, fotos, graicos, entrevistas y encuestas de opinion.");            // Description to use in the frontend
define ('SITE_KEYWORDS', "opennemas, demo.opennemas.com, diario, periodico, prensa, press, daily, newspaper, noticias, news, breaking news, Spain, internacional, titulares, headlines, albums, videos, sociedad, cultura, opinion, ultimas noticias, deportes, sport, encuestas, gente, politica, tendencias, tiempo, weather, buscador, especiales");              // Keyworks to use in the frontend
...
define ('BD_USER', "opennemas");
define ('BD_PASS', "12OpenNeMaS34");
...
//define ('SITE_PATH',  '/home/opennemas/demo2/public/' );
