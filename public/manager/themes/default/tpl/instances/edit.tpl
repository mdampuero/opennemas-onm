                ...
                <tr>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input name="settings[BD_HOST]" value="{$instance->settings['BD_HOST']|default:"localhost"}" type="text"></input></td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><input name="settings[BD_USER]" id="settings_bd_user" value="{$instance->settings['BD_USER']}" type="text"></input></td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <td valign="top">
                        <div class="help-block margin-left-1 red">
                            ...
                            <div class="content">{t escape=off}Please doble check your {/t}</div>
                        </div>
                    </td>
                </tr>
            </tbody>
