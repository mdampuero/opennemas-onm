...
( function() {
	CKEDITOR.dialog.add( 'linkadvanced', function( editor ) {
		var plugin = CKEDITOR.plugins.linkadvanced;
		...
		var targetChanged = function() {
				...
				switch ( value ) {
					case 'frame':
						targetName.setLabel( editor.lang.linkadvanced.targetFrameName );
						targetName.getElement().show();
						break;
					case 'popup':
						popupFeatures.show();
						targetName.setLabel( editor.lang.linkadvanced.targetPopupName );
						targetName.getElement().show();
						break;
					default:
		...
		var commonLang = editor.lang.common,
			linkLang = editor.lang.linkadvanced,
			anchors;
