        ...
        return {
          ...
          template: function() {
            return '<ui-select class="[% cssClass %]" ng-required="required" name="category" ng-model="$parent.ngModel" theme="select2">' +
                ...
                '<ui-select-choices group-by="groupCategories" ' +
                  'repeat="item.pk_content_category as item in (categories | filter: { title: $select.search }) track by item.pk_content_category">' +
          ...
          link: function($scope, elem, $attrs) {
            ...
            if (angular.isArray($scope.categories) &&
                ...
                $scope.categories[0].pk_content_category !== null) {
