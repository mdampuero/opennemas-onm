...
{block name="leftColumn"}
  <div class="grid simple">
    <div class="grid-body">
      ...
      {include file="ui/component/input/text.tpl" iBlock="title_int" iClick="title" iCompareTo="title" iCounter=true iFaClose="fa-chain-broken" iFaOpen="fa-chain" iField="title_int" iRequired=true iTitle="{t}Inner title{/t}" iValidation=true}
      <div class="row">
        <div class="col-sm-6">
