{foreach $accounts as $account}
  <img src="http://www.google-analytics.com/__utm.gif?utmwv=4&utmn={$random}&utmdt=Newsletter[{$date}]&utmhn={$url}&utmr={$newsurl}&utmp={$relurl}&utmac={$account}&utmcc={$utma}" style="border:0" alt="" />
{/foreach}
