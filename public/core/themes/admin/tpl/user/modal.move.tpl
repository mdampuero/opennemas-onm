<div class="modal-body">
  ...
  <h4 class="p-b-30 text-center">{t}Do you want to move contents of user?{/t}</h4>
  <div class="row m-t-15">
    <div class="col-xs-5 form-group" ng-show="!template.selected">
      <label class="form-label semi-bold" for="user">{t}Source{/t}</label>
      <div class="controls">
    ...
    <div class="col-xs-6 form-group" ng-class="{ 'col-xs-12': template.selected }">
      <label class="form-label semi-bold" for="user">{t}Target{/t}</label>
      <div class="controls">
        <onm-author-selector class="block" default-value-text="{t}Select an author{/t}…" exclude="template.exclude" ng-model="template.target" placeholder="{t}Select an author{/t}…" required></onm-author-selector>
      </div>
    </div>
  </div>
