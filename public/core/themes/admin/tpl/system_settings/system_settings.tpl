                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div ng-if="extra.theme_skins.length !== 0">
                            ...
                            <div ng-if="extra.theme_skins[settings.theme_skin].params.secondary_fonts">
                              ...
                              <div class="controls">
                                <div class="input-group">
                                  <select id="theme-font-secondary" name="theme-font-secondary" ng-model="settings.theme_font_secondary" required>
                                    <option value="[% secondary_font_name %]" ng-repeat="(secondary_font_name,secondary_font_url) in extra.theme_skins[settings.theme_skin].params.secondary_fonts" ng-selected="[% secondary_font_name === settings.theme_font_secondary %]">[% secondary_font_url %]</option>
                                  </select>
                                </div>
                              </div>
                            </div>
