...
{block name="ngInit"}
  ng-controller="SubscriberCtrl" ng-init="getItem({$id});"
{/block}
...
{block name="primaryActions"}
  <div class="all-actions pull-right">
    <ul class="nav quick-section">
      <li class="quicklinks">
        <a class="btn btn-link" class="" ng-click="expansibleSettings()" title="{t 1=_('Subscriber')}Config form: '%1'{/t}">
    ...
    <div class="grid-body no-padding">
      ...
      <div class="grid-collapse-body no-padding ng-cloak" ng-class="{ 'expanded': expanded.subscriptions }">
        ...
        <div class="p-l-15 p-t-15 p-b-15 p-r-15 b-t" ng-repeat="subscription in item.user_groups">
          ...
          <div class="checkbox" ng-if="subscription.status !== 2">
            <input id="checkbox-[% $index %]" ng-false-value="0" ng-model="subscription.status" ng-true-value="1" type="checkbox">
