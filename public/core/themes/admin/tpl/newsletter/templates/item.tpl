                ...
                <div ng-model="container.items" type="content" ui-tree-nodes="">
                  <div class="newsletter-item" ng-repeat="content in container.items" ui-tree-node>
                    ...
                    <div class="newsletter-item-search" ng-show="content.content_type === 'list'">
                      ...
                      <i class="fa fa-tags fa-lg m-r-5 m-l-5" ng-if="!['static_page'].includes(content.criteria.content_type)"></i>
                      <onm-tags-input filter="true" ng-if="!['static_page'].includes(content.criteria.content_type)" ng-model="content.criteria.tag" hide-generate="true" selection-only="true" generate-from="false" ignore-locale="true" max-results="4" placeholder="{t}Search by tag{/t}"></onm-tags-input>
                    </div>
