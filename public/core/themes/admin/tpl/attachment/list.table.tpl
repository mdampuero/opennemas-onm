...
{block name="itemActions"}
  ...
  {/acl}
  <a class="btn btn-white btn-small" href="{$app.instance->getBaseUrl()}[% data.extra.paths.attachment + item.path %]" target="_blank" uib-tooltip="{t}Download{/t}" tooltip-placement="top">
