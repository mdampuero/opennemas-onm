<div ui-tree-handle class="menu-item">
  ...
  <span class="menu-item-type-icon fa fa-bookmark" ng-if="item.type == 'category' || item.type == 'blog-category'" tooltip-placement="right" uib-tooltip="{t}Categories{/t} - [% item.title %]"></span>
