<div ui-tree-handle class="menu-item">
  ...
  <span class="menu-item-type-icon fa fa-newspaper-o" ng-if="item.type == 'blog-category'" tooltip-placement="right" uib-tooltip="{t}Manual category{/t}"></span>
  <span class="menu-item-type-icon fa fa-bookmark" ng-if="item.type == 'category'" tooltip-placement="right" uib-tooltip="{t}Automatic category{/t}"></span>
