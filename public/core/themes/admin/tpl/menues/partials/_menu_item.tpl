<div class="menu-item">
  ...
  <span class="menu-item-type-icon fa fa-exchange" ng-if="item.type == 'syncBlogCategory'" tooltip-placement="right" uib-tooltip="{t}Synched Instance{/t}"></span>
  ...
  <div class="p-l-35 p-r-35">
    <div class="row">
      <div class="col-sm-6 col-lg-6">
        ...
        <input class="menu-item-title" data-nodrag  ng-model="item.title" tooltip-enable="languageData.default !== lang" type="text" uib-tooltip="{t}Original:{/t} [% item.title %]">
      </div>
        <label class="visible-xs">
          {t}Link to{/t}
        </label>
        <input class="menu-item-link" data-nodrag  ng-model="item.link_name" tooltip-enable="languageData.default !== lang" type="text" uib-tooltip="{t}Original:{/t} [% item.link_name %]">
    </div>
  </div>
