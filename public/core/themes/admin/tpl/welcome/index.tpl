      ...
      <div class="grid simple add-contents">
        ...
        <div class="grid-body">
          <div class="actions">
            ...
            <div class="button">
              <a media-picker media-picker-mode="explore,upload" media-picker-mode-active="upload" media-picker-type="photo" id="upload-button" title="{t}Media manager{/t}" class="btn btn-white btn-large col-xs-12">
