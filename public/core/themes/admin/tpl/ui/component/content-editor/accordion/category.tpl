<div class="grid-collapse-title pointer" ng-click="expanded.category = !expanded.category">
  ...
  <span class="pull-right" ng-if="!expanded.category">
    {include file="ui/component/icon/status.tpl" iField=$field iForm="category" iRequired=true iValidation=true}
  </span>
...
<div class="grid-collapse-body ng-cloak" ng-class="{ 'expanded': expanded.category }">
  <div class="form-group no-margin">
    <div class="controls controls-validation">
      ...
      {include file="ui/component/icon/status.tpl" iClass="form-status-absolute" iField=$field iForm="category" iRequired=true iValidation=true}
    </div>
  </div>
</div>
