...
<div class="grid-collapse-body ng-cloak" ng-class="{ 'expanded' : expanded.social }">
  <div class="form-group no-margin">
      {include file="ui/component/input/text.tpl" iField="social_title" iRequired=false iTitle="{t}Title for show in Social Networks{/t}" iValidation=false iHelp="{t}Write the SEO title for this content{/t}"}
      {include file="ui/component/input/text.tpl" iField="social_description" iRequired=false iTitle="{t}Description for show in Social Networks{/t}" iValidation=false iHelp="{t}Write the SEO description for this content{/t}" }
