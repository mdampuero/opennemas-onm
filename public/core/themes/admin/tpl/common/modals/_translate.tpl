<div class="modal-body">
  ...
  <div ng-hide="template.translator.selectedTranslator" class="text-center m-t-50 p-t-30">
    <i class="fa fa-4x fa-warning text-warning"></i>
    <h4>{t escape=off 1="[% template.config.locale.available[template.translator.selectedTranslator.from] %]" 2="[% template.config.locale.available[template.translator.selectedTranslator.to] %]"}No available translators for "%1&rarr;%2"{/t}</h4>
  ...
  <div ng-show="template.translating">
    <div class="spinner-wrapper" class="text-center m-t-50 p-t-30">
      ...
      <h4 class="text-center">{t 1="[% template.config.locale.available[template.translator.selectedTranslator.to] %]"}Translating content into "%1"{/t}</h4>
    </div>
  </div>
  <div ng-show="template.translation_done">
      <div class="text-center m-t-50 p-t-30">
        <i class="fa fa-4x fa-globe"></i>
        <h4>{t 1="[% template.config.locale.available[template.translator.selectedTranslator.to] %]"}Content translated properly into "%1".{/t}</h4>
      </div>
