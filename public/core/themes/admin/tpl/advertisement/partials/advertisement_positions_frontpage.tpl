<div class="col-md-9">
  <div class="row">
    <div class="col-md-12">
      {include file="advertisement/partials/ad_position_selector.tpl" position_id="50" size="(800X600)" center=true}
    </div>
  </div>
  <hr>
  <div class="row">
  ...
  <div class="row">
    <div class="col-md-6">
      {include file="advertisement/partials/ad_position_selector.tpl" position_id="9" size="(972X90"}
    </div>
  </div>
  <hr>
  <div class="row">
    <div class="col-md-6">
      {include file="advertisement/partials/ad_position_selector.tpl" position_id="1" size="(728X90"}
    </div>
    <div class="col-md-6">
      {include file="advertisement/partials/ad_position_selector.tpl" position_id="2" size="(234X90"}
    </div>
  </div>
  <hr>
  <div class="row">
    <div class="col-md-12">
      {include file="advertisement/partials/ad_position_selector.tpl" position_id="7" size="(max-468x60"}
    </div>
  </div>
  <hr>
  <div class="row">
    <div class="col-md-12">
      {capture name="size"}{t}Floating ads (for drop them into columns){/t}{/capture}
      {include file="advertisement/partials/ad_position_selector.tpl" position_id="37" size=$size center=true}
    </div>
  </div>
  <hr>
  <div class="row">
