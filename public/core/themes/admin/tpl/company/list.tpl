...
{block name="ngInit"}
  ng-controller="CompanyListCtrl" ng-init="forcedLocale = '{$locale}'; init()"
{/block}
  ...
  <div class="all-actions pull-right">
    <ul class="nav quick-section">
      {acl isAllowed="COMPANY_CREATE"}
        <li class="quicklinks">
            <a class="btn btn-success text-uppercase" href="{url name=backend_company_create}" title="{t}New company{/t}" id="create-button">
...
{block name="list"}
  {include file="company/list.table.tpl"}
{/block}
