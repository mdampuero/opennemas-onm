...
{block name="rightColumn"}
  ...
  <div class="grid simple" ng-show="type == 'script' || type == 'external'">
    <div class="grid-body no-padding">
      ...
      {include file="common/component/related-contents/_featured-media.tpl" iName="featuredFrontpage" iRequired="type == 'script' || type == 'external'" iTitle="{t}Featured frontpage{/t}"}
    </div>
  </div>
{/block}
