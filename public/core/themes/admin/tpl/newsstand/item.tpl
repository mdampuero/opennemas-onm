...
{block name="primaryActions"}
  <div class="all-actions pull-right">
    <ul class="nav quick-section">
      ...
      <li class="quicklinks">
        <a class="btn btn-link" ng-click="expansibleSettings()" title="{t 1=_('Newsstand')}Config form: '%1'{/t}">
          ...
          <div class="row">
            <div class="col-lg-12 col-lg-offset-0 col-sm-6 col-sm-offset-3">
              ...
              <div class="p-b-30 p-l-30 p-r-30 p-t-35">
                ...
                <a class="btn btn-white btn-block m-t-15" ng-show="item.path && !item.path.name" ng-href="{$app.instance->getBaseUrl()}[% data.extra.paths.newsstand +  '/' + item.path %]" target="_blank">
