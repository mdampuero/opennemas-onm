...
{block name="content"}
  <form ng-controller="CommentsConfigCtrl" ng-init="init({json_encode($configs)|clear_json}, {json_encode($extra)|clear_json})">
      ...
      <div class="navbar navbar-inverse">
        <div class="navbar-inner">
          ...
          <div class="all-actions pull-right">
            <ul class="nav quick-section">
              <li class="quicklinks">
                <a class="btn btn-link" href="{url name=backend_comments_list}" title="{t}Go back to list{/t}">
    ...
    <div class="content">
          ...
          <div class="form-group">
            <div class="p-l-20 row">
              ...
              <div class="comment-system col-sm-4">
                <div>
                  <a ng-model="config.comment_system" ng-click="config.comment_system = 'onm'" class="m-b-5 comment-system-block btn btn-block" ng-class="{ 'btn-primary': config.comment_system == 'onm', 'btn-white': config.comment_system != 'onm' }" uib-tooltip="{t}Use the built-in comment system{/t}">
              ...
              <div class="comment-system col-sm-4 " >
                <div>
                  <a ng-model="config.comment_system" ng-click="config.comment_system = 'facebook'" class="m-b-5 comment-system-block btn btn-block" ng-class="{ 'btn-primary': config.comment_system == 'facebook', 'btn-white': config.comment_system != 'facebook' }" uib-tooltip="{t}Use the Facebook comment system{/t}">
              ...
              <div class="comment-system col-sm-4">
                <div>
                  <a ng-model="config.comment_system" ng-click="config.comment_system = 'disqus'" class="m-b-5 comment-system-block btn btn-block" ng-class="{ 'btn-primary': config.comment_system == 'disqus', 'btn-white': config.comment_system != 'disqus' }" uib-tooltip="{t}Use the Disqus comment system{/t}">
      ...
      <div class="ng-cloak" ng-if="!config.disable_comments">
        <div ng-if="config.comment_system == 'onm'">
          <div class="grid simple">
            <div class="grid-title">
              <h4>
        ...
        <div ng-if="config.comment_system == 'facebook'">
          <div class="grid simple">
            ...
            <div class="grid-body">
              <div class="alert alert-danger m-l-20" role="alert" ng-if="!config.facebook_apikey.trim()"> {t}Please enter your Facebook settings{/t} </div>
              <div class="form-group m-l-20" ng-class="{ 'has-error' : !config.facebook_apikey.trim() }">
        ...
        <div ng-if="config.comment_system == 'disqus'">
          <div class="grid simple">
            <div class="grid-title">
              <h4>
                <i class="fa fa-cog"></i>
            ...
            <div class="grid-body">
              <div class="alert alert-danger m-l-20" role="alert" ng-if="!config.disqus_shortname || !config.disqus_secretkey"> {t}Please enter your Disqus settings{/t} </div>
              <div class="row">
                <div class="col-sm-6 col-xs-12">
                  <div class="form-group m-l-20" ng-class="{ 'has-error' : !config.disqus_shortname }">
                    <label class="form-label" for="shortname">
                      Disqus Id (config.disqus_shortname)
                    </label>
                    <div class="controls">
                      <input class="form-control" id="shortname" name="shortname" required type="text" ng-model="config.disqus_shortname"/>
                      <div class="help">
                ...
                <div class="col-sm-6 col-xs-12">
                  <div class="form-group m-l-20" ng-class="{ 'has-error' : !config.disqus_secretkey }">
                    <label class="form-label" for="secret_key">
                      Disqus API Secret Key
                    </label>
                    <div class="controls">
                      <input class="form-control" id="secret_key" name="secret-key" required type="text" ng-model="config.disqus_secretkey"/>
                      <div class="help">
