  ...
  angular.module('ManagerApp.controllers')
    ...
    .controller('StorageTasksCtrl', [
      ...
      function($controller, $location, $scope, $timeout, $uibModal, http, messenger, oqlDecoder, oqlEncoder, webStorage) {
        ...
        $scope.columns = {
          collapsed: 1,
          selected: [ 'name', 'command', 'instance_id', 'status', 'params', 'created' ]
        };
            ...
            resolve: {
              ...
              success: function() {
                return function(modalWindow) {
                  var route = {
                    name: 'manager_ws_storage_task_delete',
                    params: { id: item.id }
                  };
        ...
        $scope.list = function() {
          ...
          oqlEncoder.configure({
            placeholder: {
              name: 'name ~ "[value]" or command ~ "[value]"',
            }
          });
