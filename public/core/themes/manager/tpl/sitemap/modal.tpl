<div class="modal-body">
  ...
  <h4 class="p-b-30 text-center" ng-if="!template.selected || template.selected == 1">{t}Do you want to modify this settings?{/t}</h4>
  <div class="no-margin text-center">
    <div><i class="fa fa-3x fa-warning text-warning"></i></div>
    <p class="bold m-t-10 text-uppercase">
      {t}This action can affect the performance of the platform{/t}
    </p>
  </div>
</div>
