<div class="modal-body">
  ...
  <h4 class="p-b-30 text-center" ng-if="!template.selected || template.selected == 1">{t escape=off 1="[% template.instance %]"}Do you want to delete the instance <strong>%1</strong>?{/t}</h4>
  <h4 class="p-b-30 text-center" ng-if="template.selected > 1">{t}Do you want to delete the selected instances?{/t}</h4>
</div>
