...
{block name="columnsHeader"}
  ...
  <th class="text-center pointer" ng-click="sort('storage_size')" ng-show="isColumnEnabled('storage_size')" width="80">
    <i class="fa fa-hdd-o" uib-tooltip="{t}Storage size{/t}" tooltip-placement="bottom"></i>
...
{block name="columnsBody"}
  ...
  <td class="text-center v-align-middle" ng-show="isColumnEnabled('storage_size')" title="{t}Storage size{/t}">
    <span class="badge text-bold">
