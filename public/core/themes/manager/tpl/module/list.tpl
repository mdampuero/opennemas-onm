      ...
      <ul class="nav quick-section">
        <li class="m-r-10 quicklinks">
          <div class="input-group input-group-animated">
            ...
            <input class="input-min-45 input-150" ng-class="{ 'dirty': criteria.uuid }" ng-keyup="searchByKeypress($event)" placeholder="{t}Search{/t}" ng-model="criteria.uuid" type="text">
          ...
          <tbody>
            <tr ng-repeat="item in items" ng-class="{ row_selected: isSelected(item.id) }">
              ...
              <td ng-show="isColumnEnabled('image')">
                <dynamic-image class="img-thumbnail" path="[% item.images && item.images.length > 0 ? '/' + item.images[0] : null %]" raw="true"></dynamic-image>
              </td>
