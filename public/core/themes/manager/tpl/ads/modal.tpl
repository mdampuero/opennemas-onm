<div class="modal-body">
  ...
  <h4 class="p-b-30 text-center" ng-if="!template.selected || template.selected == 1">{t}Do you want to delete the client?{/t}</h4>
  <h4 class="p-b-30 text-center" ng-if="template.selected > 1">{t}Do you want to delete the selected clients?{/t}</h4>
</div>
