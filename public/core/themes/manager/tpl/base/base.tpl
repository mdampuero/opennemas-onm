...
<body id="manager" ng-class="{ 'collapsed': sidebar.isCollapsed(), 'login-body': !app.auth.status, 'pinned': sidebar.isPinned(), 'unauthorized': !app.auth.status }" ng-app="ManagerApp" ng-controller="MasterCtrl" ng-init="init('{{$smarty.const.CURRENT_LANGUAGE}}', '{t}Any{/t}')" resizable ng-class="{ 'collapsed': sidebar.isCollapsed() }">
  ...
  {javascripts src="
    ...
    @Common/components/ckeditor4/plugins/notification/plugin.js,
    @Common/components/ckeditor4/plugins/notification/lang/en.js,
    @Common/components/ckeditor4/plugins/justify/plugin.js,
    @Common/components/ckeditor4/plugins/justify/lang/en.js,
    @Common/components/ckeditor4/plugins/justify/lang/es.js,
    ...
    @Common/src/ckeditor-linkadvanced/plugin.js,
    @Common/src/ckeditor-linkadvanced/lang/en.js,
    @Common/src/ckeditor-linkadvanced/lang/es.js,
