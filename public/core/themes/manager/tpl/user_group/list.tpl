      ...
      <ul class="nav quick-section">
        <li class="m-r-10 quicklinks">
          <div class="input-group input-group-animated">
            ...
            <input class="input-min-45 input-250" ng-class="{ 'dirty': criteria.name }" ng-keyup="searchByKeypress($event)" ng-model="criteria.name" placeholder="{t}Search{/t}" type="text">
