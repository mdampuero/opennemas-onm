    ...
    <uib-tab index="0" heading="{t}First payment{/t}">
      ...
      <ol class="m-b-30">
        <li>
          ...
          <div><img src="/core/admin/images/help/braintree_2.png" alt="Paypal"></div>
        </li>
        <li>
        ...
        <li>
          ...
          <div class="m-b-15 m-t-5"><img class="img-responsive" src="/core/admin/images/help/braintree_4.png" alt="Paypal"></div>
        </li>
        <li>
      ...
      <ol>
        <li>
          ...
          <div class="m-b-15 m-t-5"><img class="img-responsive" src="/core/admin/images/help/braintree_3.png" alt="Paypal"></div>
        </li>
        <li>
        ...
        <li>
          ...
          <div class="m-t-5"><img class="img-responsive" src="/core/admin/images/help/braintree_5.png" alt="Paypal"></div>
        </li>
      </ol>
    </uib-tab>
    <uib-tab index="1" heading="{t}Not your first payment{/t}">
      ...
      <ol>
        ...
        <li>
          ...
          <div class="m-b-15 m-t-5"><img class="img-responsive" src="/core/admin/images/help/braintree_6.png" alt="Paypal"></div>
        </li>
        <li>
