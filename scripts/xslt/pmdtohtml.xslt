...
<!-- PMD XML Style Sheet by Stefano Mancarella <[EMAIL PROTECTED]> -->
<!-- Adapted (should say copied!) from "checkstyle-noframes.xsl", created by  -->
<!-- Stephane Bailliez <[EMAIL PROTECTED]> and part of the Checkstyle      -->
<!-- distribution found at http://checkstyle.sourceforge.net                  -->
      ...
      <tr>
        <td class="bannercell" rowspan="2">
          ...
          <img src="http://jakarta.apache.org/images/jakarta-logo.gif"; alt="http://jakarta.apache.org"; align="left" border="0"/>
    		...
    		<tr>
    		<td class="text-align:right">Designed for use with <a href='http://pmd.sourceforge.net/'>PMD</a> and <a href='http://ant.apache.org'>Ant</a>.</td>
    		</tr>
      </table>
    	<hr size="1"/>
