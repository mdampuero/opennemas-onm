It's one script to refactorize id's and generate slugs from old opennemas DB.
This script add new usergroup Master and change some users.
If you need execute this, please, first you have to check changes DB. And review
...
4. If you want clear all values that there aren't in contents table.
   execute ./clear.php