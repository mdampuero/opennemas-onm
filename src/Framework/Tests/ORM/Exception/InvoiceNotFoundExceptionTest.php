...
class InvoiceNotFoundExceptionTest extends \PHPUnit_Framework_TestCase
{
    public function testGetMessageWithPreviousMessage()
    {
        ...
        $e = new InvoiceNotFoundException($id, $source, $error);
    ...
    public function testGetMessageWithoutPreviousMessage()
    {
        ...
        $e = new InvoiceNotFoundException($id, $source);
