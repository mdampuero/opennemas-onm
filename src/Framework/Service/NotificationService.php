    ...
    private function getBody($instance)
    {
        ...
        if ($instance->users > 1) {
            $body .=
                '<li>'
                .sprintf(
                    _('You have %d activated users. Note that <a href="http://help.opennemas.com/knowledgebase/articles/566172-pricing-opennemas-user-licenses" title="Get more info about user licensing">the cost is %s € user/month</a>'),
                    $instance->users,
                    12
                )
                .'</li>';
