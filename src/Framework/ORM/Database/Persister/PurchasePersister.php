...
class PurchasePersister extends DatabasePersister
{
    /**
     * {@inheritdoc}
     */
    public function create(Entity &$entity)
    {
        ...
        $this->mconn->insert('purchase', $data);
    ...
    {
        $this->mconn->delete('purchase', [ 'id' => $entity->id ]);
    ...
    public function update(Entity $entity)
    {
        ...
        $this->mconn->update('purchase', $data, [ 'id' => $entity->id ]);
        $this->mcache->delete($entity->getCachedId());
    }
}
