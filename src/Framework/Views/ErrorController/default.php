...
<head>
    ...
    <style type="text/css">
        ...
        .error-trace .backtrace .title {
            width:100%; background:#aaa; font-size:12px;
            text-transform:uppercase; border-radius: 0; padding:0; color: White;
            font-weight:bold;
        }
