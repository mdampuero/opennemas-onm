...
class RedisTokenProvider implements TokenProvider
{
    ...
    public function getAccessToken()
    {
        return $this->execute(function () {
            return $this->conn->get('pressclipping-access-token');
        }, []);
    }
    ...
    {
        return $this->execute(function () {
            return $this->conn->get('pressclipping-refresh-token');
        }, []);
    }
    ...
    {
        return $this->execute(function () {
            return $this->conn->exists('pressclipping-access-token');
        }, []);
    }
    ...
    {
        return $this->execute(function () {
            return $this->conn->exists('pressclipping-refresh-token');
        }, []);
    }
    ...
    public function setAccessToken($token, $ttl)
    {
        return $this->execute(function ($a, $b) {
            $this->conn->set('pressclipping-access-token', $a, $b);
    ...
    public function setRefreshToken($token)
    {
        return $this->execute(function ($a) {
            $this->conn->set('pressclipping-refresh-token', $a);
