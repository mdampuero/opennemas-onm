 ...
 */
namespace Common\External\PressClipping\Component\Factory;

use Common\External\PressClipping\Component\Authentication\Authentication;

class PressClippingFactory
{
    /**
     * The PressClipping authentication service.
     *
     * @var Authentication
     */
    protected $auth;
    ...
    /**
     * The PressClipping configuration.
     *
     * @var array
     */
    protected $config;
