    ...
    if(frm.campo1.value != '') {
	     	    	var capa='divinfor'+$('numcapa').value; 	     	    		        
				   		   ...
				   		   if((carac.ancho == 650) || (carac.ancho == 300)) {
					   		  	opener.document.getElementById( capa).innerHTML = " <table border='0' bgcolor='#ccffbb' width='370' cellpadding='4'><tr><td> <b> Aceptada. </b> <br>El ancho de la imagen es correcto para la portada. </td></tr></table>" ;	  		  		
					   		  }else{		   		  	
					   		  	opener.document.getElementById( capa ).innerHTML = " <table border='0' bgcolor='red' width='370' cellpadding='4'><tr><td> <b> Cuidado: </b> <br>El ancho no es correcto para la portada. </td></tr></table>" ;
					   		  }	
			          opener.document.getElementById(capa).innerHTML = opener.document.getElementById(capa).innerHTML +"<table border='0'width='370' cellpadding='4'><tr><td> <b> Archivo: </b>" + frm.campo1.value + "<br> <b>Ancho: </b>" + carac.ancho + "px <br> <b>Alto: </b>"+ carac.alto + "px <br> <b>Peso: </b>" +$('tamanho').value +" KB <br> <b>Fecha de creacion: </b>" +$('fecha').value +"</td></tr></table>";		          
			        
					if(!isNameOk(frm.campo1.value)){
					   	  opener.document.getElementById( capa ).innerHTML =  opener.document.getElementById( capa ).innerHTML + "<table border='0' bgcolor='orange' width='370' cellpadding='4'><tr><td> <b> Cuidado: </b> <br>El Nombre contiene espacios en blanco o caracteres especiales.</td></tr></table>" ;
					}
				       opener.document.getElementById( capa ).style.display = "inline";   
				       var mini= 'new'+$('numcapa').value;  
				      
				        opener.document.getElementById( mini ).src = "../media/images/"+frm.campo1.value      			    
