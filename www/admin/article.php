...
if(isset($_REQUEST['action']) ) {
    switch($_REQUEST['action']) {
        ...
        case 'new':   // Crear un nuevo artículo
            if( !Privileges_check::CheckPrivileges('ADD_NOT')) {
                Privileges_check::AccessDeniedAction();
            }
        ...
        case 'read':
            if( !Privileges_check::CheckPrivileges('UPD_NOT')) {
                Privileges_check::AccessDeniedAction();
            }
        ...
        case 'update':
            ...
            if( !Privileges_check::CheckPrivileges('UPD_NOT', $_SESSION['privileges']) &&
        ...
        case 'preview':
            ...
            if(!$_POST["id"] || empty($_POST["id"])) {
                if( !Privileges_check::CheckPrivileges('ADD_NOT',$_SESSION['privileges'])) {
                    Privileges_check::AccessDeniedAction();
                }
                $_POST['fk_publisher']=$_SESSION['userid'];
                //Estamos creando un nuevo artículo
        ...
        case 'delete':
                ...
                if( !Privileges_check::CheckPrivileges('DEL_NOT',$_SESSION['privileges']) &&
                    ($articleCheck->fk_user_last_editor)!=$_SESSION['userid']) {
                    Privileges_check::AccessDeniedAction();
                }
        ...
        case 'available_status':
            if( !Privileges_check::CheckPrivileges('APR_NOT')) {
                Privileges_check::AccessDeniedAction();
            }
            $article = new Article($_REQUEST['id']);
            // FIXME: evitar otros valores erróneos
