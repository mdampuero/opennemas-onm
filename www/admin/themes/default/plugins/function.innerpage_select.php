...
/**
 * Smarty plugin innerpage_select
 * 
 * <code>
 * {innerpage_select name="form_id" selected=$fk_page disableRecursive=$pk_page}
 *
 ...
 * @return string
 */
function smarty_function_innerpage_select($params, &$smarty)
{
    $html = '';
