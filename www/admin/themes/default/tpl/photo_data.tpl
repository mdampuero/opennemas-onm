...
<div id="nifty" style="width:1100px;">
    <b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
        <table border='0' width="96%">
            <tr>
                <td align='left'>
                    <img src="/media/images/{$photo1->path_file}{$photo1->name}" id="change1" border="0" style="padding-left:20px;max-width:440px;max-height:380px;" onload="initialize()" onunload="GUnload()" />
                </td>                 
                <td align='left'>
                 ...
                 <td>
                 {literal}
                      <script src="http://maps.google.com/maps?file=api&v=2&sensor=true&key=ABQIAAAAgVYidVUmCOyFEL1KAC7tghQJR_LXbPqqwncjGUyvKhj9Se7DcxQ695vw-U5JMqKYXn1wwVOx6RIh3g" type="text/javascript"></script>
                      {/literal}

                      <p>
                        <input type="text" value="{$photo1->address}"  id="address" name="address[{$photo1->id}]" size="20">
                        <input type="button" value="IR" onClick="showAddress(); return false;" />
                      </p>
                      
                      <div id="map_canvas" style="width: 200px; height: 320px"></div>
