    ...
    <li>
        <a href="#" class="admin_add" onClick="enviar(this, '_self', 'new', -1);"
           title="Nueva palabra clave">
            <img border="0" src="{php}echo($this->image_dir);{/php}list-add.png" title="Nueva palabra clave" alt="" ><br />Nueva
        </a>
    </li>    
</ul>
</div>
    ...
    <li>
        <a href="#" class="admin_add" onClick="javascript:enviar(this, '_self', 'save', $('id').value);"
           value="Guardar" title="Guardar">
            <img border="0" src="{php}echo($this->image_dir);{/php}save.gif" title="Guardar" alt="Guardar" /><br />Guardar
        </a>
    </li>
    <li>
