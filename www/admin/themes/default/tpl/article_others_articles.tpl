<table class="adminlist">
    <tr>
        ...
        <th align="center" style="width:50px;">Portada</th>
        <th align="center" style="width:50px;">Eliminar</th>


    </tr>
    <tr><td colspan="13">
     <div id="artic" class="seccion" style="float:left;width:100%;border:1px solid gray;">
            <div id="art" class="seccion" style="float:left;width:100%;border:1px solid gray;"> <br />
                ...
                {section name=d loop=$articles}
                    <table id="tabla{$aux}" name="tabla{$aux}" width="100%" value="{$articles[d]->id}" class="tabla" style="text-align:center;padding:0px;">
                        <tr {cycle values="class=row0,class=row1"}  style="cursor:pointer;" >                            
                            ...
                            {/if}
                                <td class='no_width' style="width:50px;" align="center">
