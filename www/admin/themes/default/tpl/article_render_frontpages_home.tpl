        ...
        <td  align="center" style="width:50px;">
         ...
         <td style="width:50px;" align="center">
            <div class="inhome" style="display:inline;">
                {if $item->in_home == 1}
                   <img class="inhome" src="{php}echo($this->image_dir);{/php}gohome.png" border="0" alt="Publicado en home" title="Publicado en home"/>
                {elseif $item->in_home == 2}                  
                    <img class="inhome" src="{php}echo($this->image_dir);{/php}gosuggesthome.png" border="0" alt="Sugerida en home" title="Sugerida en home"/>
                {else}                  
                      <img class="inhome" src="{php}echo($this->image_dir);{/php}home_no.png" border="0" alt="No publicada en home" title="No publicada en home"/>
                {/if}
            </div>
        </td>
        <td  align="center"  style="width:50px;">
