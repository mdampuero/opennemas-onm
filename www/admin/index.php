...
#user_activity {
    background:transparent url(<?=$RESOURCES_PATH?>images/users_activity.png) top right no-repeat;
    cursor: pointer;
    text-align: right;
				...
				<tr>
					<td id="logoonm">
						<a href="index.php"  class="logout" title="Ir a la página principal de administración">
							<img src="<?=$RESOURCES_PATH?>images/logo-opennemas.png" border="0" align="absmiddle" alt="Inicio" width="136" height=30"" />&nbsp;
						</a>
					</td>
					<td>                                                
                        <?php
                        ...
                        <div id="user_box" style="width:auto;">
                            ...
                            <div id="name-box" style="float:left; margin-right:5px;">
                              <strong>
                                ...
                                <?php if($_SESSION['isAdmin']): ?>
                                    <img src="<?=$RESOURCES_PATH?>images/key.png" border="0" align="absmiddle"
                            ...
                            <div id="session-actions" style="float:left;">
                              <a href="javascript:salir();" class="logout" title="Salir del panel de control">
                                  <img src="<?=$RESOURCES_PATH?>images/logout.png" border="0"
                        ...
                        <div id="user_mailbox">                            
                            <a href="https://www.google.com/accounts/ServiceLoginAuth?service=mail&Email=<?php echo $_SESSION['email'] ?>&continue=https%3A%2f%2fmail.google.com%2fmail"
                               ...
                               target="_blank">
                                    ...
                                    <img src="<?=$RESOURCES_PATH?>images/gmail_ico.png" border="0" align="absmiddle" />
                            </a>
                        </div>
                        <?php endif; ?>
                    </td>
