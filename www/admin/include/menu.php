...
<menu>
    ...
    <submenu title="Contents" link="#index.php" target="centro">
        ...
        <node title="Advertisements" link="3advertisement.php" privilege="ADVERTISEMENT_ADMIN" />        
    ...
    <submenu title="Configuration" link="#" privilege="BACKEND_ADMIN,CACHE_ADMIN">
        <node title="Settings Manager" link="#"  privilege="BACKEND_ADMIN" />
        <node title="Cache Manager" link="#" privilege="CACHE_ADMIN" />
        <node title="Information" link="#" privilege="BACKEND_ADMIN" />
        <node title="APC" link="index.php" privilege="CACHE_ADMIN" />
        <node title="System Updater" route="systemupdater-index-index"  privilege="BACKEND_ADMIN" />
        <node title="Mysql-Check" link="#" privilege="BACKEND_ADMIN" />
        <node title="Help" link="#" privilege="BACKEND_ADMIN" />
    </submenu>
</menu>
MENUSTRING;
