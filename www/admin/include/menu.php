...
<menu>
    ...
    <submenu title="Contents" link="index.php" target="centro">
        <node title="Articles" link="article.php?action=list_pendientes" target="centro" privilege="ARTICLE_ADMINPEND" />
        ...
        <node title="Sections Manager" link="category.php" target="centro" privilege="WIDGET_ADMIN" />        
    </submenu>

    <submenu title="Media" link="#" target="centro" privilege="IMAGE_ADMIN,VIDEO_ADMIN,ALBUM_ADMIN,FILE_ADMIN,GRAPHICS_ADMIN">
    ...
    <submenu title="Users" link="#" target="centro" privilege="USER_ADMIN">
    ...
    <submenu title="Utilities" link="#" target="centro" privilege="BACKEND_ADMIN,CACHE_ADMIN,SEARCH_ADMIN,TRASH_ADMIN,PCLAVE_ADMIN">
        <node title="Avanced Search" link="search_advanced.php" target="centro" privilege="SEARCH_ADMIN" />        
        <node title="Trash" link="litter.php" target="centro" privilege="TRASH_ADMIN" />
        ...
        <node title="Dashboard" link="dashboard.php" target="centro" privilege="BACKEND_ADMIN" />
    </submenu>
    
    <submenu title="Configuration" link="#" target="centro" privilege="BACKEND_ADMIN,CACHE_ADMIN">
        <node title="Settings Manager" link="configurator.php" target="centro"  privilege="BACKEND_ADMIN" />
        ...
        <node title="Help" link="index.php" target="centro" privilege="BACKEND_ADMIN" />
        <node title="APC" link="index.php" target="centro" privilege="CACHE_ADMIN" />
        <node title="SVN" link="svn.php" target="centro"  privilege="BACKEND_ADMIN" />
        <node title="Mysql-Check" link="mysql-check.php?action=check" target="centro" privilege="BACKEND_ADMIN" />
    </submenu>    
</menu>
MENUSTRING;
