...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
     ...
     * @var array
     */
    public static $standardPlugins = array('Cache', 'Html', 'Database', 'Exception', 'File', 'Memory', 'Registry', 'Time', 'Variables', 'Smarty', 'Adodb');
    ...
    {
        $panel = '<h4>ZFDebug v'.$this->_version.' - adapted to OpenNemas</h4>' .                 
