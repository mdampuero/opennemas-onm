...
//$articles_viewed = $cm->getMostViewedContent('Article', true, $category_data['id']);
 $articles_viewed = $cm->getAllMostViewed(true, $category_data['id'],6);

//$articles_comments = $cm->getAllMostVoted(true, $category_data['id'],6);
 $articles_comments = $cm->getAllMostComented(true, $category_data['id'],6);
