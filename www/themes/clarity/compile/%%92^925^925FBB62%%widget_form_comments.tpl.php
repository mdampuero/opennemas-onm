        ...
        <div class="form span-14">
            <form action="" name="comentar" id="comentar" onSubmit="return false;">
                ...
                <div class="static-form span-8">
                    ...
                    <input type="hidden" id="id" name="id" value="<?php echo $this->_tpl_vars['content']->id; ?>
"/>
                    <input type="hidden" id="category" name="category" value="<?php echo $this->_tpl_vars['content']->category; ?>
"/>
            ...
            /* <![CDATA[ */                        
            var fbAppKey = '<?php echo @FB_APP_APIKEY; ?>
';
