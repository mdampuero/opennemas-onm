<?php /* Smarty version 2.6.18, created on 2010-04-21 23:46:20
         compiled from frontpage_article_head.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', 'frontpage_article_head.tpl', 9, false),array('modifier', 'clearslash', 'frontpage_article_head.tpl', 9, false),array('function', 'renderTypeRelated', 'frontpage_article_head.tpl', 27, false),)), $this); ?>
<div class="nw-big">
     <div class="nw-category-name">
        <span class="spacer">&nbsp;</span><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']->category_title)) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)))) ? $this->_run_mod_handler('clearslash', true, $_tmp) : clearslash($_tmp)); ?>
...
" />
         <?php endif; ?>
          <h3 class="nw-title-big"><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']->permalink)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : clearslash($_tmp)); ?>
...
">
          ...
          <p class="nw-subtitle">
            <?php echo ((is_array($_tmp=$this->_tpl_vars['item']->summary)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : clearslash($_tmp)); ?>
