<?php /* Smarty version 2.6.18, created on 2010-03-03 11:45:11
         compiled from frontpage_article.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'clearslash', 'frontpage_article.tpl', 10, false),array('modifier', 'upper', 'frontpage_article.tpl', 12, false),array('function', 'renderTypeRelated', 'frontpage_article.tpl', 23, false),)), $this); ?>


<div class="nw-big">
     <?php if (! empty ( $this->_tpl_vars['item']->img1_path )): ?>
         <img style="width:300px;" class="nw-image" src="<?php echo @MEDIA_IMG_PATH_WEB; ?>
...
"/>
     <?php endif; ?>
    <div class="nw-category-name science"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']->subtitle)) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)))) ? $this->_run_mod_handler('clearslash', true, $_tmp) : clearslash($_tmp)); ?>
</div>
...
?>
                    <?php if ($this->_tpl_vars['relacionadas'][$this->_sections['r']['index']]->pk_article != $this->_tpl_vars['item']->pk_article): ?>
                       <?php echo smarty_function_renderTypeRelated(array('content' => $this->_tpl_vars['relacionadas'][$this->_sections['r']['index']]), $this);?>
