...
position:relative;
overflow:hidden;
background-image:url(../images/filetesFondoNoticias.gif);
}
...
.firma_diario,.firma_fecha,.firma_hora,.ColumnHome2-author_daily,.ColumnHome2-author_date,.ColumnHome2-author_hour,.CComentarios {
float:left;
}
...
font-family:Arial;
color:#004b8e;
background:url(../images/menu/opcion.gif) repeat-x 0 -2px;
}
...
.menuCabeceraTexto ul li a:hover {
padding-top:1px;
position:relative;
display:inline;
float:left;
height:22px;
background:url(../images/menu/hover.gif) repeat-x 0 -2px;
color:#fff;
padding-left:13px;
padding-right:13px;
}
...
display:inline;
float:left;
background:url(../images/menu/seleccion.gif) repeat-x 0 -2px;
color:#fff;
}
...
.CContainerIconoTextoNoticiaMas {
padding-bottom:10px;
float:left;
display:inline;
position:relative;
...
display:inline;
position:relative;
background-image:url(../images/noticiasRecomendadas/iconoNoticiaMas.gif);
background-repeat:no-repeat;
}
...
.containerNoticiasMasVistasYValoradas {
overflow:hidden;
width:295px;
float:left;
display:inline;
