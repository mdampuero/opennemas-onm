...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'clearslash', 'container_article_col2.tpl', 2, false),array('modifier', 'count_words', 'container_article_col2.tpl', 5, false),array('function', 'articledate', 'container_article_col2.tpl', 7, false),array('function', 'typecontent', 'container_article_col2.tpl', 32, false),)), $this); ?>
...
?>
            <?php if (! strcmp ( strval ( $this->_tpl_vars['myId'] ) , strval ( $this->_tpl_vars['item']->id ) ) && ! empty ( $this->_tpl_vars['i'] )): ?>
                <div class="ColumnHome2_photo">
                    <div class="ColumnHome2_photo2"><img height="105" src="<?php echo $this->_tpl_vars['MEDIA_IMG_PATH_WEB']; ?>
