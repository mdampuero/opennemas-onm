...
{include file="modulo_header.tpl"}
            ...
            {if $category_name eq 'home'}
                ...
                <div class="containerActualVideosYDeportes">
                    {include file="index_containeractualidad.tpl"}
                    {include file="index_deportesexpress.tpl"}
                </div>
                <div class="separadorHorizontal"></div>
                <div class="titularesDia">
                    {include file="index_cabeceratitulares.tpl"}
...
{if !isset($smarty.session.userid) || empty($smarty.session.userid)}
    ...
    {/scriptsection}
{/if}
{include file="preview_advice.tpl"}
</body>
</html>