<div class="CContainerCabeceraOpinion">
    ...
    <div class="CHeaderArticle">
        <div class="superior">
            <div class="share">
                COMPARTIR OPINION:
                <a href="http://chuza.org/submit.php?url=http://{$smarty.server.SERVER_NAME}{$opinion->permalink|clearslash}" title="Chuza!"><img src="{$params.IMAGE_DIR}enviarA/chuza.gif" alt="Chuza!" /></a>
