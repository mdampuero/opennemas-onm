<div class="containerTiempo">
    <div class="cabeceraTiempo">
        <a href="/tempo"><img alt="El TiempoXornal" src="{$params.IMAGE_DIR}tiempo/logoCabeceraTiempo.gif"/></a>
    </div>
    <div class="cuerpoTiempo">
        <div class="zonaMapaTiempo">
            <img src="{$smarty.const.MEDIA_PATH_URL}/weather/mapa.gif" usemap="#mapTempoColumna" />
        ...
        <div class="listaEnlacesFotoVideoDia">
            <div class="enlaceFotoVideoDia">
                <div class="enlaceFotoVideoDia">
                    <img src="{$params.IMAGE_DIR}fotoVideoDia/flechitaAzul.gif" alt=""/>
                    <a href="{$smarty.const.SITE_URL}tempo/acoruna.html" title="Predicción del tiempo en A Coruña">
                        A Coru&ntilde;a</a>
                </div>
            ...
            <div class="enlaceFotoVideoDia">
                <div class="enlaceFotoVideoDia">
                    <img src="{$params.IMAGE_DIR}fotoVideoDia/flechitaAzul.gif" alt=""/>
                    <a href="{$smarty.const.SITE_URL}tempo/ferrol.html" title="Predicción del tiempo en Ferrol">
                        Ferrol</a>
                </div>
                <div class="fileteFotoVideoDia"></div>
            </div>
            <div class="enlaceFotoVideoDia">
                <div class="enlaceFotoVideoDia">
                    <img src="{$params.IMAGE_DIR}fotoVideoDia/flechitaAzul.gif" alt=""/>
                    <a href="{$smarty.const.SITE_URL}tempo/lugo.html" title="Predicción del tiempo en Lugo">
                        Lugo</a>
                </div>
                <div class="fileteFotoVideoDia"></div>
            </div>
            <div class="enlaceFotoVideoDia">
                <div class="enlaceFotoVideoDia">
                    <img src="{$params.IMAGE_DIR}fotoVideoDia/flechitaAzul.gif" alt=""/>
                    <a href="{$smarty.const.SITE_URL}tempo/ourense.html" title="Predicción del tiempo en Ourense">
                        Ourense</a>
                </div>
                <div class="fileteFotoVideoDia"></div>
            </div>
            <div class="enlaceFotoVideoDia">
                <div class="enlaceFotoVideoDia">
                    <img src="{$params.IMAGE_DIR}fotoVideoDia/flechitaAzul.gif" alt=""/>
                    <a href="{$smarty.const.SITE_URL}tempo/pontevedra.html" title="Predicción del tiempo en Pontevedra">
                        Pontevedra</a>
                </div>
                <div class="fileteFotoVideoDia"></div>
            </div>
            <div class="enlaceFotoVideoDia">
                <div class="enlaceFotoVideoDia">
                    <img src="{$params.IMAGE_DIR}fotoVideoDia/flechitaAzul.gif" alt=""/>
                    <a href="{$smarty.const.SITE_URL}tempo/santiago.html" title="Predicción del tiempo en Santiago">
                        Santiago</a>
                </div>
                <div class="fileteFotoVideoDia"></div>
            </div>
            <div class="enlaceFotoVideoDia">
                <div class="enlaceFotoVideoDia">
                    <img src="{$params.IMAGE_DIR}fotoVideoDia/flechitaAzul.gif" alt=""/>
                    <a href="{$smarty.const.SITE_URL}tempo/vigo.html" title="Predicción del tiempo en Vigo">
                        Vigo</a>
                </div>
                <div class="fileteFotoVideoDia"></div>
            </div>
