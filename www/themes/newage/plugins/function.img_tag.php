...
/**
 * Smarty {img_tag} function plugin
 *
 * Type:     function<br>
 * Name:     img_tag<br>
 * Date:     Jan 28, 2003<br>
 * Purpose:  format HTML tags for the image with support for assets server<br>
 * Input:<br>
...
function smarty_function_img_tag($params, &$smarty)
{
    ...
    return ($prefix . '<img src="'.$asset_server.$path_prefix.$file.'" alt="'.$alt.'" width="'.$width.'" height="'.$height.'"'.$extra.' />' . $suffix);
}
