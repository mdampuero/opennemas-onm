<?php /* Smarty version 2.6.18, created on 2010-02-08 03:00:08
         compiled from container_article_destacado.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'clearslash', 'container_article_destacado.tpl', 2, false),array('modifier', 'count_words', 'container_article_destacado.tpl', 5, false),array('function', 'articledate', 'container_article_destacado.tpl', 7, false),array('function', 'typecontent', 'container_article_destacado.tpl', 26, false),)), $this); ?>
<div class="CNoticiaHome1">
    <div class="antetitulo"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']->subtitle)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
     ...
     <h2 style="font-size:2.3em;font-weight:800;"><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']->permalink)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
...
" /></div>
    ...
    <p style="width: 410px;"><?php if (! empty ( $this->_tpl_vars['item']->summary )): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['item']->summary)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
