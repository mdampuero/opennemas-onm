<?php /* Smarty version 2.6.18, created on 2010-01-25 20:30:46
         compiled from container_article_col2_especial.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'clearslash', 'container_article_col2_especial.tpl', 3, false),array('modifier', 'count_words', 'container_article_col2_especial.tpl', 6, false),array('function', 'articledate', 'container_article_col2_especial.tpl', 8, false),array('function', 'typecontent', 'container_article_col2_especial.tpl', 28, false),)), $this); ?>
 <div class="ColumnHome2Especial">
  <div class="noticiaEspecial">
     <div class="ColumnHome2-preHeader"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']->subtitle)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
          ...
          <h2 style="font-size:20px;"><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']->permalink)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
