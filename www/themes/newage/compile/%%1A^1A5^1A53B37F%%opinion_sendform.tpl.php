<?php /* Smarty version 2.6.18, created on 2010-01-27 11:56:53
         compiled from opinion_sendform.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'clearslash', 'opinion_sendform.tpl', 45, false),)), $this); ?>
    ...
    <div class="noticia">
        ...
        <form method="POST" action="/opinion.php">
            ...
            <tr> 
                <th>Comentario:</th>
                <td>
                    <textarea name="body" rows="8" cols="50"><?php echo ((is_array($_tmp=$this->_tpl_vars['opinion']->title)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
</textarea>
                </td>
            </tr>
            <tr> 
            ...
            <input type="hidden" name="opinion_id"     value="<?php echo $this->_tpl_vars['opinion']->id; ?>
" />
