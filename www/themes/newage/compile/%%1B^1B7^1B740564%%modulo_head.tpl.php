<?php /* Smarty version 2.6.18, created on 2010-02-08 20:22:38
         compiled from modulo_head.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'modulo_head.tpl', 62, false),array('modifier', 'clearslash', 'modulo_head.tpl', 62, false),array('modifier', 'truncate', 'modulo_head.tpl', 64, false),array('modifier', 'regex_replace', 'modulo_head.tpl', 64, false),array('modifier', 'escape', 'modulo_head.tpl', 64, false),array('block', 'stylesection', 'modulo_head.tpl', 110, false),array('block', 'scriptsection', 'modulo_head.tpl', 139, false),array('function', 'stylesheet_include_tag', 'modulo_head.tpl', 111, false),)), $this); ?>
...
/" />
<?php endif; ?>
<?php $this->_tag_stack[] = array('stylesection', array('name' => 'index','compress' => true,'cssfilename' => "index.css.php")); $_block_repeat=true;smarty_block_stylesection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php echo smarty_function_stylesheet_include_tag(array('file' => "actualidadVideosFotos.css,fotoVideoDia.css,genteXornal.css,laBolsa.css,noticiasXPress.css,titularesDia.css,ultimaHora.css",'baseurl' => $this->_tpl_vars['params']['CSS_DIR']), $this);?>
...
<?php $this->_tag_stack[] = array('stylesection', array('name' => 'common','compress' => true,'cssfilename' => "common.css.php")); $_block_repeat=true;smarty_block_stylesection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php echo smarty_function_stylesheet_include_tag(array('file' => "bannerPublicidad.css,default.css,galeriaVideos.css,galeriaFotos.css,home_noticias.css,laBolsa.css,menu.css,menuSeccion.css,noticia.css,noticiasRecomendadas.css,opinion.css,paginador.css,pestanyas.css,pie.css,pieza_encuesta.css,portada_opinion.css,style.css,tiempo.css,lightwindow.css,carousel.css,rss.css",'baseurl' => $this->_tpl_vars['params']['CSS_DIR']), $this);?>
