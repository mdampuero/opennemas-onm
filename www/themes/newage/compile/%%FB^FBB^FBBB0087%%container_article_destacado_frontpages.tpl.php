<?php /* Smarty version 2.6.18, created on 2010-01-26 21:05:56
...
<div class="CNoticiaHome1" style="width:620px;">
    <div class="antetitulo"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']->subtitle)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
     ...
     <h2 style="font-size:30px;width:600px;"><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']->permalink)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
