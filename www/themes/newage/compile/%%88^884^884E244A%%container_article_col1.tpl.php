<?php /* Smarty version 2.6.18, created on 2010-02-08 03:04:09
         compiled from container_article_col1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'clearslash', 'container_article_col1.tpl', 2, false),array('modifier', 'count_words', 'container_article_col1.tpl', 5, false),array('function', 'articledate', 'container_article_col1.tpl', 7, false),array('function', 'typecontent', 'container_article_col1.tpl', 40, false),)), $this); ?>
<div class="CNoticiaHome1">
    ...
    <h2 style="font-size:1.8em;font-weight:800;"><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']->permalink)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "visor_video.tpl", 'smarty_include_vars' => array('video' => $this->_tpl_vars['item']->obj_video)));
...
" /></div>
    ...
    <?php endif; ?>
    <p style="width: 410px;">
        <?php if (! empty ( $this->_tpl_vars['item']->summary )): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['item']->summary)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
...
?>
    ...
    <div class="CContenedorParticipacion">
        ...
        <div class="CComentarios">
            Comentarios: <?php if ($this->_tpl_vars['numcomment1'][$this->_tpl_vars['art_id']] >= 1): ?> (<?php echo $this->_tpl_vars['numcomment1'][$this->_tpl_vars['art_id']]; ?>
)<?php endif; ?>
            <a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']->permalink)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
#COpina">Opinar</a>
        </div>
        <?php endif; ?>
            </div>
