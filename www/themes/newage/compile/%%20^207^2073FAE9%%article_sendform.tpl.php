<?php /* Smarty version 2.6.18, created on 2010-01-28 01:30:06
         compiled from article_sendform.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'clearslash', 'article_sendform.tpl', 46, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Enviar esta noticia a un amigo</title>
...
xornal-logo.jpg" alt="Xornal.com - Xornal de Galicia"
    ...
    <div class="noticia">
        ...
        <?php if ($_REQUEST['action'] == 'sendform'): ?>
        <h4>Enviar esta noticia a un amigo</h4>
        <form method="POST" action="/article.php?category_name=<?php echo $this->_tpl_vars['category_name']; ?>
&subcategory_name=<?php echo $this->_tpl_vars['subcategory_name']; ?>
">
            ...
            <tr> 
                <th>Comentario:</th>
                <td>
                    <textarea name="body" rows="8" cols="50"><?php echo ((is_array($_tmp=$this->_tpl_vars['article']->title)) ? $this->_run_mod_handler('clearslash', true, $_tmp) : smarty_modifier_clearslash($_tmp)); ?>
</textarea>
                </td>
            </tr>
            <tr> 
