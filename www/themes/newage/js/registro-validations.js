...
Validation.add('validate-min-length', 'Tu nick tiene que tener un mínimo de 6 caracteres (sin espacios ni números).', function(v) {
    /* pattern : new RegExp("^[0-9]{3}\-[0-9]{3}\-[0-9]{3}$","gi") */
    var reg_exp = new RegExp("^[a-zA-ZáéíóúñÁÉÍÓÚÑüÜ]{6,}$", "gi");
...
Validation.add('validate-pasaporte', 'Este campo debe ser un DNI (12345678L), NIE (X1234567L), pasaporte o DIE válido.', function(v) {                
    //var reg_exp = new RegExp("^([0-9]{8}[TRWAGMYFPDXBNJZSQVHLCKET])|([XYZ][0-9]{7}[A-Z])$","gi");
    var reg_exp = new RegExp("^[0-9A-Z]{2,15}$","gi");
...
Validation.add('check-baseslegales', 'Debe aceptar las bases legales para poder registrarse como usuario.', function(v,elm){
