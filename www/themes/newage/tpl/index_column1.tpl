<div class="column1">
    ...
    {if !empty($destaca)}
        {if ($destaca[0]->columns neq '2' && $category_name neq 'home') || ($destaca[0]->home_columns neq '2' && $category_name eq 'home')}    
            ...
            {renderplaceholder video=$video_destacada items=$destaca  relationed=$relationed tpl='container_article_destacado.tpl' placeholder="placeholder_0_0"}
        {/if}
    {/if}
    
    {renderplaceholder items=$articles_home tpl='container_article_col1.tpl' placeholder="placeholder_0_0"}    
    ...
    {else}
        {renderplaceholder items=$column tpl='container_article_col1.tpl' placeholder="placeholder_0_1"}
    {/if}

    {if !empty($paginacion)} {* ¿?¿?¿?¿? hai paxinación en home ¿?¿?¿?¿? *}
        <p align='center'>
