<div class="CNoticiaHome1">
    <div class="antetitulo">{$item->subtitle|clearslash}</div>
     <h2 style="font-size:2.3em;font-weight:800;"><a href="{$item->permalink|clearslash}">{$item->title|clearslash}</a></h2>
    <div class="firma">
    ...
    <p style="width: 410px;">{if !empty($item->summary)}{$item->summary|clearslash}<span class="CSigue"> <a href="{$item->permalink|clearslash}"></a></span>{else}&nbsp;{/if}</p>
