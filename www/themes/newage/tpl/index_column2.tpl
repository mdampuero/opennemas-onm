<div class="column2">
    ...
    {insert name="renderbanner" type=5 cssclass="contBannerPublicidad" width="245" height="245"
    ...
    <!-- ****************** PUBLICIDAD ******************* -->
    <div class="contBannerYTextoPublicidad">
    {insert name="renderbanner" type=14 cssclass="contBannerPublicidad" width="245" height="245"
        beforeHTML='<div class="textoBannerPublicidad">publicidad</div>'  afterHTML='<div class="separadorHorizontal"></div>'}
    </div>
    ...
    {else}
        {renderplaceholder items=$column tpl='container_article_col2.tpl' placeholder="placeholder_1_3"}
    {/if}
    
    
    <!-- ****************** PUBLICIDAD ******************* -->
    <div class="contBannerYTextoPublicidad">
    {insert name="renderbanner" type=16 cssclass="contBannerPublicidad" width="245" height="245"
        beforeHTML='<div class="textoBannerPublicidad">publicidad</div>' afterHTML='<div class="separadorHorizontal"></div>'}
    </div>  
</div>