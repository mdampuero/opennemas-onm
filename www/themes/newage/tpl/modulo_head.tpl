...
{/if}
{stylesection name="index" compress=true cssfilename="index.css.php"}
{stylesheet_include_tag file="actualidadVideosFotos.css,fotoVideoDia.css,genteXornal.css,laBolsa.css,noticiasXPress.css,titularesDia.css,ultimaHora.css" baseurl=$params.CSS_DIR}
{/stylesection}
