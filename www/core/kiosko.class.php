...
class Kiosko extends Content {
    ...
    */
    ...
    function create($data) {
        ...
        $paper_pdf_path = MEDIA_PATH.'/files/kiosko'.$path;
        $paper_image_path = MEDIA_PATH.'/images/kiosko'.$path;
	...
	$sql = 'DELETE FROM kioskos WHERE pk_kiosko='.($this->id);
        ...
        $paper_pdf = MEDIA_PATH.'/files/kiosko'.$this->path.$this->name;
        $paper_image = MEDIA_PATH.'/images/kiosko'.$this->path.preg_replace("/.pdf$/",".jpg",$this->name);
        unlink($paper_pdf);
        unlink($paper_image);
    ...
    */
    ...
    function createThumb($file_pdf,$path) {
        ...
        $pdf_path = MEDIA_PATH.'/files/kiosko'.$path;
        $image_path = MEDIA_PATH.'/images/kiosko'.$path;
