<?php
/**
* Outputs relative dates to the current time
*
* @param string $timestamp UNIX timestamp or a date which can be converted by strtotime()
* @param int $days use date only and ignore the time
* @param string $format (optional) a php date format (for dates over 1 year)
*
* @return string
*/
